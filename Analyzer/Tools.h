...
namespace tools {
    ...
    bool triggerEmulatorReturned_EWKFOID(const pat::Electron *iE, double jetPt);
    bool isoTriggerEmulator(const pat::Electron *iE, double mvavalue);
    bool triggerEmulator(const pat::Muon *iM);
    ...
    bool TightID(TString theid, const pat::Electron *iE, edm::Handle< std::vector<reco::Conversion> > &theConversions, reco::BeamSpot::Point BS, reco::Vertex::Point PV, double mvavalue,double miniiso, bool use3DIPsig=true);
    bool TightIso(TString theid,const pat::Electron *iE, double mvavalue, double miniiso, double  ptratio, double ptrel );
    bool TightID_EWK(TString theid, const pat::Electron *iE, edm::Handle< std::vector<reco::Conversion> > &theConversions, reco::BeamSpot::Point BS, reco::Vertex::Point PV, double mvavalue, double lepmva, double miniiso, bool use3DIPsig=true);
    bool FOID(TString theid, const pat::Electron *iE, edm::Handle< std::vector<reco::Conversion> > &theConversions, reco::BeamSpot::Point BS, reco::Vertex::Point PV, double mvavalue, double miniiso, bool use3DIPsig =true);
    bool FOID_EWK(TString theid, const pat::Electron *iE, edm::Handle< std::vector<reco::Conversion> > &theConversions, reco::BeamSpot::Point BS, reco::Vertex::Point PV, double mvavalue, double lepmva, double ptratio, double jetCSV, double jetPt, double miniiso, bool use3DIPsig =true);
    bool VetoID(const pat::Electron *iE, edm::Handle< std::vector<reco::Conversion> > &theConversions, reco::BeamSpot::Point BS, reco::Vertex::Point PV, double mvavalue, double miniiso);
    bool VetoID_EWK(const pat::Electron *iE, edm::Handle< std::vector<reco::Conversion> > &theConversions, reco::BeamSpot::Point BS, reco::Vertex::Point PV, double mvavalue, double miniiso);
    bool EleCutBasedLooseID_MiniIso(const pat::Electron *iE, edm::Handle< std::vector<reco::Conversion> > &theConversions,reco::BeamSpot::Point BS, reco::Vertex::Point PV, double miniiso);
    bool EleCutBasedTightID(const pat::Electron *iE, edm::Handle< std::vector<reco::Conversion> > &theConversions, reco::BeamSpot::Point BS, reco::Vertex::Point PV) ;
    
    bool TightID(TString theid,const pat::Muon *iM, reco::Vertex::Point PV,  double miniiso, bool use3DIPsig =true) ;
    bool TightIso(TString theid,const pat::Muon *iM,  double miniiso, double  ptratio, double ptrel );
    bool TightID_EWK(TString theid, const pat::Muon *iM, reco::Vertex::Point PV, double lepmva, double miniiso, bool use3DIPsig=true);
    bool FOID(TString theid,const pat::Muon *iM, reco::Vertex::Point PV, double miniiso, bool use3DIPsig=true);
    bool FOID_EWK(TString theid, const pat::Muon *iM, reco::Vertex::Point PV, double lepmva, double ptratio, double jetCSV, double miniiso, bool use3DIPsig=true);
    bool SoftTightID(const pat::Muon *iM, reco::Vertex::Point PV, reco::Vertex thevtx) ;
    bool VetoID(const pat::Muon *iM, reco::Vertex::Point PV, double miniiso);
    bool VetoID_EWK(const pat::Muon *iM, reco::Vertex::Point PV, double miniiso);
    bool MuonLooseID_MiniIso(const pat::Muon *iM, reco::Vertex::Point PV, double miniiso);


    std::vector<const pat::Tau* > ssbLooseTauSelector(const std::vector<pat::Tau>  & thePatTaus,
							     double v_tau_pt,
							     reco::Vertex::Point PV,
							     double v_tau_d0,
							     const bool usedz);
    bool FOID(TString theid, const pat::Tau *iT, reco::Vertex::Point PV, bool use3DIPsig);
      
    bool TightID(TString theid, const pat::Tau *iT, reco::Vertex::Point PV, bool use3DIPsig);

    bool TightIso(  const pat::Tau *iT );

    bool PassMETFilters(const edm::Event& iEvent,edm::EDGetTokenT<edm::TriggerResults> metfilters_token,edm::EDGetTokenT<bool>filterbadChCand_token,edm::EDGetTokenT<bool>filterbadPFMuon_token);
