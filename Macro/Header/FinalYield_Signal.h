...
#ifndef FinalYield_Signal_h
#define FinalYield_Signal_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TBranch        *b__jetDeltaRloose;   //!
    ...
    TBranch       *b__mLSP;
    TBranch       *b__mchargino;
    TBranch       *b__mneutralino2;

   FinalYield_Signal(TTree *tree=0);
   virtual ~FinalYield_Signal();
   ...
   virtual void     Show(Long64_t entry = -1);
    ...
    double FindSignalXSection(double& mchargino, double& mneutralino2);
    int FindLSPIndex(double& mLSP);
    int FindCNIndex(double& mneutralino2);
    ...
    double CalcTriggerEff(int& MapType, int& l, int& l1, int& l2);
    ////////////////////////////////////////////
    ////////////////////////////////////////////
    /*
...
#ifdef FinalYield_Signal_cxx
FinalYield_Signal::FinalYield_Signal(TTree *tree) : fChain(0) 
{
...
FinalYield_Signal::~FinalYield_Signal()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FinalYield_Signal::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FinalYield_Signal::LoadTree(Long64_t entry)
{
...
void FinalYield_Signal::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("_jetDeltaRloose", &_jetDeltaRloose, &b__jetDeltaRloose);
    ...
    fChain->SetBranchAddress("_mLSP", &_mLSP, &b__mLSP);
    fChain->SetBranchAddress("_mchargino", &_mchargino, &b__mchargino);
    fChain->SetBranchAddress("_mneutralino2", &_mneutralino2, &b__mneutralino2);
    
   Notify();
}

Bool_t FinalYield_Signal::Notify()
{
...
void FinalYield_Signal::Show(Long64_t entry)
{
...
Int_t FinalYield_Signal::Cut(Long64_t entry)
{
...
#endif // #ifdef FinalYield_Signal_cxx
