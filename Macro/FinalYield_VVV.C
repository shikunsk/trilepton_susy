...
void FinalYield::Loop()
{
    ...
    TH1F* MCYield_VVV[nSRCat];
    TH1F* MCYield_VVV_JECUp[nSRCat];
    TH1F* MCYield_VVV_JECDown[nSRCat];
    TH1F* MCYield_VVV_BTagUp[nSRCat];
    TH1F* MCYield_VVV_BTagDown[nSRCat];
    TH1F* MCYield_VVV_LepSFUp[nSRCat];
    TH1F* MCYield_VVV_LepSFDown[nSRCat];
    TH1F* MCYield_VVV_PUUp[nSRCat];
    TH1F* MCYield_VVV_PUDown[nSRCat];
    
    TH1F* MCYield_VVV_Pt1[nSRCat];
    TH1F* MCYield_VVV_Pt2[nSRCat];
    TH1F* MCYield_VVV_Pt3[nSRCat];
    TH1F* MCYield_VVV_Mll[nSRCat];
    TH1F* MCYield_VVV_MT[nSRCat];
    TH1F* MCYield_VVV_MET[nSRCat];
    TH1F* MCYield_VVV_M3l[nSRCat];
    TH1F* MCYield_VVV_SumQ[nSRCat];
    
    for (int i=0; i<nSRCat; i++) {
        name="MCBG_VVV_"+SRCat[i];
        MCYield_VVV[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_VVV[i]->Sumw2();
        name="MCBG_VVV_JECUp_"+SRCat[i];
        MCYield_VVV_JECUp[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_VVV_JECUp[i]->Sumw2();
        name="MCBG_VVV_JECDown_"+SRCat[i];
        MCYield_VVV_JECDown[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_VVV_JECDown[i]->Sumw2();
        name="MCBG_VVV_BTagUp_"+SRCat[i];
        MCYield_VVV_BTagUp[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_VVV_BTagUp[i]->Sumw2();
        name="MCBG_VVV_BTagDown_"+SRCat[i];
        MCYield_VVV_BTagDown[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_VVV_BTagDown[i]->Sumw2();
        name="MCBG_VVV_LepSFUp_"+SRCat[i];
        MCYield_VVV_LepSFUp[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_VVV_LepSFUp[i]->Sumw2();
        name="MCBG_VVV_LepSFDown_"+SRCat[i];
        MCYield_VVV_LepSFDown[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_VVV_LepSFDown[i]->Sumw2();
        name="MCBG_VVV_PUUp_"+SRCat[i];
        MCYield_VVV_PUUp[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_VVV_PUUp[i]->Sumw2();
        name="MCBG_VVV_PUDown_"+SRCat[i];
        MCYield_VVV_PUDown[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_VVV_PUDown[i]->Sumw2();
        
        name="MCBG_VVV_Pt1_"+SRCat[i];
        MCYield_VVV_Pt1[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        MCYield_VVV_Pt1[i]->Sumw2();
        name="MCBG_VVV_Pt2_"+SRCat[i];
        MCYield_VVV_Pt2[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        MCYield_VVV_Pt2[i]->Sumw2();
        name="MCBG_VVV_Pt3_"+SRCat[i];
        MCYield_VVV_Pt3[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        MCYield_VVV_Pt3[i]->Sumw2();
        name="MCBG_VVV_Mll_"+SRCat[i];
        MCYield_VVV_Mll[i]=new TH1F(name,"",Mllbin[i],Mlllowerbound,Mllupperbound[i]);
        MCYield_VVV_Mll[i]->Sumw2();
        name="MCBG_VVV_MT_"+SRCat[i];
        MCYield_VVV_MT[i]=new TH1F(name,"",MTbin[i],MTlowerbound,MTupperbound[i]);
        MCYield_VVV_MT[i]->Sumw2();
        name="MCBG_VVV_MET_"+SRCat[i];
        MCYield_VVV_MET[i]=new TH1F(name,"",METbin[i],METlowerbound,METupperbound[i]);
        MCYield_VVV_MET[i]->Sumw2();
        name="MCBG_VVV_M3l_"+SRCat[i];
        MCYield_VVV_M3l[i]=new TH1F(name,"",M3lbin[i],M3llowerbound,M3lupperbound[i]);
        MCYield_VVV_M3l[i]->Sumw2();
        name="MCBG_VVV_SumQ_"+SRCat[i];
        MCYield_VVV_SumQ[i]=new TH1F(name,"",SumQbin[i],SumQlowerbound,SumQupperbound[i]);
        MCYield_VVV_SumQ[i]->Sumw2();
    }
            ...
            if (nTau==0) {
                ...
                if (!bJetandMETflag_JECUp) {
                    if (CatA) {
                        ...
                        MCYield_VVV_JECUp[0]->Fill(SRIndex,W);
                    }
                    if (CatB) {
                        SRIndex=CalcSRIndex_B(_met_JECup,Mll,Mt_JECUp);
                        MCYield_VVV_JECUp[1]->Fill(SRIndex,W);
                    }
                }
                //JECDown
                if (!bJetandMETflag_JECDown) {
                    if (CatA) {
                        ...
                        MCYield_VVV_JECDown[0]->Fill(SRIndex,W);
                    }
                    if (CatB) {
                        SRIndex=CalcSRIndex_B(_met_JECdown,Mll,Mt_JECDown);
                        MCYield_VVV_JECDown[1]->Fill(SRIndex,W);
                    }
                }
                //NO JEC
                if (!bJetandMETflag) {
                    ...
                    if (CatA) {
                        ...
                        MCYield_VVV[0]->Fill(SRIndex,W);
                        MCYield_VVV_BTagUp[0]->Fill(SRIndex,W_BTagUp);
                        MCYield_VVV_BTagDown[0]->Fill(SRIndex,W_BTagDown);
                        MCYield_VVV_LepSFUp[0]->Fill(SRIndex,W_LepSFUp);
                        MCYield_VVV_LepSFDown[0]->Fill(SRIndex,W_LepSFDown);
                        MCYield_VVV_PUUp[0]->Fill(SRIndex,W_PUUp);
                        MCYield_VVV_PUDown[0]->Fill(SRIndex,W_PUDown);
                    }
                    if (CatB) {
                        SRIndex=CalcSRIndex_B(_met,Mll,Mt);
                        MCYield_VVV[1]->Fill(SRIndex,W);
                        MCYield_VVV_BTagUp[1]->Fill(SRIndex,W_BTagUp);
                        MCYield_VVV_BTagDown[1]->Fill(SRIndex,W_BTagDown);
                        MCYield_VVV_LepSFUp[1]->Fill(SRIndex,W_LepSFUp);
                        MCYield_VVV_LepSFDown[1]->Fill(SRIndex,W_LepSFDown);
                        MCYield_VVV_PUUp[1]->Fill(SRIndex,W_PUUp);
                        MCYield_VVV_PUDown[1]->Fill(SRIndex,W_PUDown);
                    }
                    ///////////////////////////////////////////////
                    //Fill SR Hist Before Overflow Bin Adjustment//
                    ///////////////////////////////////////////////
                    ...
                    //////FILL HIST////////
                    if (CatA) {
                        MCYield_VVV_Pt1[0]->Fill(leadingPt_FL,W);
                        MCYield_VVV_Pt2[0]->Fill(subleadingPt_FL,W);
                        MCYield_VVV_Pt3[0]->Fill(trailingPt_FL,W);
                        MCYield_VVV_Mll[0]->Fill(Mll_FL,W);
                        MCYield_VVV_MT[0]->Fill(Mt_FL,W);
                        MCYield_VVV_MET[0]->Fill(_met_FL,W);
                        MCYield_VVV_M3l[0]->Fill(M3l_FL,W);
                        MCYield_VVV_SumQ[0]->Fill(SumQ,W);
                    }
                    if (CatB) {
                        MCYield_VVV_Pt1[1]->Fill(leadingPt_FL,W);
                        MCYield_VVV_Pt2[1]->Fill(subleadingPt_FL,W);
                        MCYield_VVV_Pt3[1]->Fill(trailingPt_FL,W);
                        MCYield_VVV_Mll[1]->Fill(Mll_FL,W);
                        MCYield_VVV_MT[1]->Fill(Mt_FL,W);
                        MCYield_VVV_MET[1]->Fill(_met_FL,W);
                        MCYield_VVV_M3l[1]->Fill(M3l_FL,W);
                        MCYield_VVV_SumQ[1]->Fill(SumQ,W);
                    }
            ...
            if (nTau==1) {
                ...
                if (!bJetandMETflag_JECUp) {
                    if (CatC) {
                        ...
                        MCYield_VVV_JECUp[2]->Fill(SRIndex,W);
                    }
                    if (CatD) {
                        SRIndex=CalcSRIndex_D(_met_JECup,Mll,Mt2_JECUp);
                        MCYield_VVV_JECUp[3]->Fill(SRIndex,W);
                    }
                    if (CatE) {
                        SRIndex=CalcSRIndex_E(_met_JECup,Mll,Mt2_JECUp);
                        MCYield_VVV_JECUp[4]->Fill(SRIndex,W);
                    }
                }
                //JECDown
                if (!bJetandMETflag_JECDown) {
                    if (CatC) {
                        ...
                        MCYield_VVV_JECDown[2]->Fill(SRIndex,W);
                    }
                    if (CatD) {
                        SRIndex=CalcSRIndex_D(_met_JECdown,Mll,Mt2_JECDown);
                        MCYield_VVV_JECDown[3]->Fill(SRIndex,W);
                    }
                    if (CatE) {
                        SRIndex=CalcSRIndex_E(_met_JECdown,Mll,Mt2_JECDown);
                        MCYield_VVV_JECDown[4]->Fill(SRIndex,W);
                    }
                }
                //NO JEC
                if (!bJetandMETflag) {
                    ...
                    if (CatC) {
                        ...
                        MCYield_VVV[2]->Fill(SRIndex,W);
                        MCYield_VVV_BTagUp[2]->Fill(SRIndex,W_BTagUp);
                        MCYield_VVV_BTagDown[2]->Fill(SRIndex,W_BTagDown);
                        MCYield_VVV_LepSFUp[2]->Fill(SRIndex,W_LepSFUp);
                        MCYield_VVV_LepSFDown[2]->Fill(SRIndex,W_LepSFDown);
                        MCYield_VVV_PUUp[2]->Fill(SRIndex,W_PUUp);
                        MCYield_VVV_PUDown[2]->Fill(SRIndex,W_PUDown);
                    }
                    if (CatD) {
                        SRIndex=CalcSRIndex_D(_met,Mll,Mt2);
                        MCYield_VVV[3]->Fill(SRIndex,W);
                        MCYield_VVV_BTagUp[3]->Fill(SRIndex,W_BTagUp);
                        MCYield_VVV_BTagDown[3]->Fill(SRIndex,W_BTagDown);
                        MCYield_VVV_LepSFUp[3]->Fill(SRIndex,W_LepSFUp);
                        MCYield_VVV_LepSFDown[3]->Fill(SRIndex,W_LepSFDown);
                        MCYield_VVV_PUUp[3]->Fill(SRIndex,W_PUUp);
                        MCYield_VVV_PUDown[3]->Fill(SRIndex,W_PUDown);
                    }
                    if (CatE) {
                        SRIndex=CalcSRIndex_E(_met,Mll,Mt2);
                        MCYield_VVV[4]->Fill(SRIndex,W);
                        MCYield_VVV_BTagUp[4]->Fill(SRIndex,W_BTagUp);
                        MCYield_VVV_BTagDown[4]->Fill(SRIndex,W_BTagDown);
                        MCYield_VVV_LepSFUp[4]->Fill(SRIndex,W_LepSFUp);
                        MCYield_VVV_LepSFDown[4]->Fill(SRIndex,W_LepSFDown);
                        MCYield_VVV_PUUp[4]->Fill(SRIndex,W_PUUp);
                        MCYield_VVV_PUDown[4]->Fill(SRIndex,W_PUDown);
                    }
                    ///////////////////////////////////////////////
                    //Fill SR Hist Before Overflow Bin Adjustment//
                    ///////////////////////////////////////////////
                    ...
                    if (CatC) {
                        MCYield_VVV_Pt1[2]->Fill(leadingPt_FL,W);
                        MCYield_VVV_Pt2[2]->Fill(subleadingPt_FL,W);
                        MCYield_VVV_Pt3[2]->Fill(trailingPt_FL,W);
                        MCYield_VVV_Mll[2]->Fill(Mll_FL,W);
                        MCYield_VVV_MT[2]->Fill(Mt2_FL,W);
                        MCYield_VVV_MET[2]->Fill(_met_FL,W);
                        MCYield_VVV_M3l[2]->Fill(M3l_FL,W);
                        MCYield_VVV_SumQ[2]->Fill(SumQ,W);
                    }
                    if (CatD) {
                        MCYield_VVV_Pt1[3]->Fill(leadingPt_FL,W);
                        MCYield_VVV_Pt2[3]->Fill(subleadingPt_FL,W);
                        MCYield_VVV_Pt3[3]->Fill(trailingPt_FL,W);
                        MCYield_VVV_Mll[3]->Fill(Mll_FL,W);
                        MCYield_VVV_MT[3]->Fill(Mt2_FL,W);
                        MCYield_VVV_MET[3]->Fill(_met_FL,W);
                        MCYield_VVV_M3l[3]->Fill(M3l_FL,W);
                        MCYield_VVV_SumQ[3]->Fill(SumQ,W);
                    }
                    if (CatE) {
                        MCYield_VVV_Pt1[4]->Fill(leadingPt_FL,W);
                        MCYield_VVV_Pt2[4]->Fill(subleadingPt_FL,W);
                        MCYield_VVV_Pt3[4]->Fill(trailingPt_FL,W);
                        MCYield_VVV_Mll[4]->Fill(Mll_FL,W);
                        MCYield_VVV_MT[4]->Fill(Mt2_FL,W);
                        MCYield_VVV_MET[4]->Fill(_met_FL,W);
                        MCYield_VVV_M3l[4]->Fill(M3l_FL,W);
                        MCYield_VVV_SumQ[4]->Fill(SumQ,W);
                    }
                }//NO JEC
            ...
            if (nTau==2) {
                ...
                if (!bJetandMETflag_JECUp) {
                    if (CatF) {
                        ...
                        MCYield_VVV_JECUp[5]->Fill(SRIndex,W);
                    }
                }
                //JECDown
                if (!bJetandMETflag_JECDown) {
                    if (CatF) {
                        ...
                        MCYield_VVV_JECDown[5]->Fill(SRIndex,W);
                    }
                }
                //NO JEC
                if (!bJetandMETflag) {
                    ...
                    if (CatF) {
                        ...
                        MCYield_VVV[5]->Fill(SRIndex,W);
                        MCYield_VVV_BTagUp[5]->Fill(SRIndex,W_BTagUp);
                        MCYield_VVV_BTagDown[5]->Fill(SRIndex,W_BTagDown);
                        MCYield_VVV_LepSFUp[5]->Fill(SRIndex,W_LepSFUp);
                        MCYield_VVV_LepSFDown[5]->Fill(SRIndex,W_LepSFDown);
                        MCYield_VVV_PUUp[5]->Fill(SRIndex,W_PUUp);
                        MCYield_VVV_PUDown[5]->Fill(SRIndex,W_PUDown);
                    }
                    ///////////////////////////////////////////////
                    //Fill SR Hist Before Overflow Bin Adjustment//
                    ///////////////////////////////////////////////
                    ...
                    if (CatF) {
                        MCYield_VVV_Pt1[5]->Fill(leadingPt_FL,W);
                        MCYield_VVV_Pt2[5]->Fill(subleadingPt_FL,W);
                        MCYield_VVV_Pt3[5]->Fill(trailingPt_FL,W);
                        MCYield_VVV_Mll[5]->Fill(Mll_FL,W);
                        MCYield_VVV_MT[5]->Fill(Mt2_FL,W);
                        MCYield_VVV_MET[5]->Fill(_met_FL,W);
                        MCYield_VVV_M3l[5]->Fill(M3l_FL,W);
                        MCYield_VVV_SumQ[5]->Fill(SumQ,W);
                    }
                }//NO JEC
    ...
    //Hists for plots
    TH1F* Plot_MCYield_VVV[nSRCat];
    TH1F* Plot_MCYield_VVV_Pt1[nSRCat];
    TH1F* Plot_MCYield_VVV_Pt2[nSRCat];
    TH1F* Plot_MCYield_VVV_Pt3[nSRCat];
    TH1F* Plot_MCYield_VVV_Mll[nSRCat];
    TH1F* Plot_MCYield_VVV_MT[nSRCat];
    TH1F* Plot_MCYield_VVV_MET[nSRCat];
    TH1F* Plot_MCYield_VVV_M3l[nSRCat];
    TH1F* Plot_MCYield_VVV_SumQ[nSRCat];
    
    TH1F* Plot_StatUnc_MCYield_VVV[nSRCat];
    TH1F* Plot_StatUnc_MCYield_VVV_Pt1[nSRCat];
    TH1F* Plot_StatUnc_MCYield_VVV_Pt2[nSRCat];
    TH1F* Plot_StatUnc_MCYield_VVV_Pt3[nSRCat];
    TH1F* Plot_StatUnc_MCYield_VVV_Mll[nSRCat];
    TH1F* Plot_StatUnc_MCYield_VVV_MT[nSRCat];
    TH1F* Plot_StatUnc_MCYield_VVV_MET[nSRCat];
    TH1F* Plot_StatUnc_MCYield_VVV_M3l[nSRCat];
    TH1F* Plot_StatUnc_MCYield_VVV_SumQ[nSRCat];
    
    TH1F* Plot_TotUnc_MCYield_VVV[nSRCat];
    TH1F* Plot_TotUnc_MCYield_VVV_Pt1[nSRCat];
    TH1F* Plot_TotUnc_MCYield_VVV_Pt2[nSRCat];
    TH1F* Plot_TotUnc_MCYield_VVV_Pt3[nSRCat];
    TH1F* Plot_TotUnc_MCYield_VVV_Mll[nSRCat];
    TH1F* Plot_TotUnc_MCYield_VVV_MT[nSRCat];
    TH1F* Plot_TotUnc_MCYield_VVV_MET[nSRCat];
    TH1F* Plot_TotUnc_MCYield_VVV_M3l[nSRCat];
    TH1F* Plot_TotUnc_MCYield_VVV_SumQ[nSRCat];
    //Hists for plots
    
    for (int i=0; i<nSRCat; i++) {
        
        Plot_MCYield_VVV[i]=(TH1F*)MCYield_VVV[i]->Clone();
        Plot_MCYield_VVV_Pt1[i]=(TH1F*)MCYield_VVV_Pt1[i]->Clone();
        Plot_MCYield_VVV_Pt2[i]=(TH1F*)MCYield_VVV_Pt2[i]->Clone();
        Plot_MCYield_VVV_Pt3[i]=(TH1F*)MCYield_VVV_Pt3[i]->Clone();
        Plot_MCYield_VVV_Mll[i]=(TH1F*)MCYield_VVV_Mll[i]->Clone();
        Plot_MCYield_VVV_MT[i]=(TH1F*)MCYield_VVV_MT[i]->Clone();
        Plot_MCYield_VVV_MET[i]=(TH1F*)MCYield_VVV_MET[i]->Clone();
        Plot_MCYield_VVV_M3l[i]=(TH1F*)MCYield_VVV_M3l[i]->Clone();
        Plot_MCYield_VVV_SumQ[i]=(TH1F*)MCYield_VVV_SumQ[i]->Clone();
        
        name="Plot_StatUnc_MCBG_VVV_"+SRCat[i];
        Plot_StatUnc_MCYield_VVV[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        Plot_StatUnc_MCYield_VVV[i]->Sumw2();
        name="Plot_StatUnc_MCBG_VVV_Pt1_"+SRCat[i];
        Plot_StatUnc_MCYield_VVV_Pt1[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        Plot_StatUnc_MCYield_VVV_Pt1[i]->Sumw2();
        name="Plot_StatUnc_MCBG_VVV_Pt2_"+SRCat[i];
        Plot_StatUnc_MCYield_VVV_Pt2[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        Plot_StatUnc_MCYield_VVV_Pt2[i]->Sumw2();
        name="Plot_StatUnc_MCBG_VVV_Pt3_"+SRCat[i];
        Plot_StatUnc_MCYield_VVV_Pt3[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        Plot_StatUnc_MCYield_VVV_Pt3[i]->Sumw2();
        name="Plot_StatUnc_MCBG_VVV_Mll_"+SRCat[i];
        Plot_StatUnc_MCYield_VVV_Mll[i]=new TH1F(name,"",Mllbin[i],Mlllowerbound,Mllupperbound[i]);
        Plot_StatUnc_MCYield_VVV_Mll[i]->Sumw2();
        name="Plot_StatUnc_MCBG_VVV_MT_"+SRCat[i];
        Plot_StatUnc_MCYield_VVV_MT[i]=new TH1F(name,"",MTbin[i],MTlowerbound,MTupperbound[i]);
        Plot_StatUnc_MCYield_VVV_MT[i]->Sumw2();
        name="Plot_StatUnc_MCBG_VVV_MET_"+SRCat[i];
        Plot_StatUnc_MCYield_VVV_MET[i]=new TH1F(name,"",METbin[i],METlowerbound,METupperbound[i]);
        Plot_StatUnc_MCYield_VVV_MET[i]->Sumw2();
        name="Plot_StatUnc_MCBG_VVV_M3l_"+SRCat[i];
        Plot_StatUnc_MCYield_VVV_M3l[i]=new TH1F(name,"",M3lbin[i],M3llowerbound,M3lupperbound[i]);
        Plot_StatUnc_MCYield_VVV_M3l[i]->Sumw2();
        name="Plot_StatUnc_MCBG_VVV_SumQ_"+SRCat[i];
        Plot_StatUnc_MCYield_VVV_SumQ[i]=new TH1F(name,"",SumQbin[i],SumQlowerbound,SumQupperbound[i]);
        Plot_StatUnc_MCYield_VVV_SumQ[i]->Sumw2();
        
        name="Plot_TotUnc_MCBG_VVV_"+SRCat[i];
        Plot_TotUnc_MCYield_VVV[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        Plot_TotUnc_MCYield_VVV[i]->Sumw2();
        name="Plot_TotUnc_MCBG_VVV_Pt1_"+SRCat[i];
        Plot_TotUnc_MCYield_VVV_Pt1[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        Plot_TotUnc_MCYield_VVV_Pt1[i]->Sumw2();
        name="Plot_TotUnc_MCBG_VVV_Pt2_"+SRCat[i];
        Plot_TotUnc_MCYield_VVV_Pt2[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        Plot_TotUnc_MCYield_VVV_Pt2[i]->Sumw2();
        name="Plot_TotUnc_MCBG_VVV_Pt3_"+SRCat[i];
        Plot_TotUnc_MCYield_VVV_Pt3[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        Plot_TotUnc_MCYield_VVV_Pt3[i]->Sumw2();
        name="Plot_TotUnc_MCBG_VVV_Mll_"+SRCat[i];
        Plot_TotUnc_MCYield_VVV_Mll[i]=new TH1F(name,"",Mllbin[i],Mlllowerbound,Mllupperbound[i]);
        Plot_TotUnc_MCYield_VVV_Mll[i]->Sumw2();
        name="Plot_TotUnc_MCBG_VVV_MT_"+SRCat[i];
        Plot_TotUnc_MCYield_VVV_MT[i]=new TH1F(name,"",MTbin[i],MTlowerbound,MTupperbound[i]);
        Plot_TotUnc_MCYield_VVV_MT[i]->Sumw2();
        name="Plot_TotUnc_MCBG_VVV_MET_"+SRCat[i];
        Plot_TotUnc_MCYield_VVV_MET[i]=new TH1F(name,"",METbin[i],METlowerbound,METupperbound[i]);
        Plot_TotUnc_MCYield_VVV_MET[i]->Sumw2();
        name="Plot_TotUnc_MCBG_VVV_M3l_"+SRCat[i];
        Plot_TotUnc_MCYield_VVV_M3l[i]=new TH1F(name,"",M3lbin[i],M3llowerbound,M3lupperbound[i]);
        Plot_TotUnc_MCYield_VVV_M3l[i]->Sumw2();
        name="Plot_TotUnc_MCBG_VVV_SumQ_"+SRCat[i];
        Plot_TotUnc_MCYield_VVV_SumQ[i]=new TH1F(name,"",SumQbin[i],SumQlowerbound,SumQupperbound[i]);
        Plot_TotUnc_MCYield_VVV_SumQ[i]->Sumw2();
    }
    ...
    for (int i=0; i<nSRCat; i++) {
         ...
         */
        //SR
        AssignUncForPlot_SRBG_NonWZ(Plot_MCYield_VVV[i], uncertainty, nbinSR, MCYield_VVV_JECUp[i], MCYield_VVV_JECDown[i], MCYield_VVV_BTagUp[i],MCYield_VVV_BTagDown[i],MCYield_VVV_LepSFUp[i],MCYield_VVV_LepSFDown[i],MCYield_VVV_PUUp[i],MCYield_VVV_PUDown[i],Plot_StatUnc_MCYield_VVV[i],Plot_TotUnc_MCYield_VVV[i]);
        //Var
        AssignUncForPlot_VarBG_NonWZ(Plot_MCYield_VVV_Pt1[i], uncertainty, nbinPt, Plot_StatUnc_MCYield_VVV_Pt1[i],Plot_TotUnc_MCYield_VVV_Pt1[i]);
        AssignUncForPlot_VarBG_NonWZ(Plot_MCYield_VVV_Pt2[i], uncertainty, nbinPt, Plot_StatUnc_MCYield_VVV_Pt2[i],Plot_TotUnc_MCYield_VVV_Pt2[i]);
        AssignUncForPlot_VarBG_NonWZ(Plot_MCYield_VVV_Pt3[i], uncertainty, nbinPt, Plot_StatUnc_MCYield_VVV_Pt3[i],Plot_TotUnc_MCYield_VVV_Pt3[i]);
        AssignUncForPlot_VarBG_NonWZ(Plot_MCYield_VVV_Mll[i], uncertainty, nbinMll, Plot_StatUnc_MCYield_VVV_Mll[i],Plot_TotUnc_MCYield_VVV_Mll[i]);
        AssignUncForPlot_VarBG_NonWZ(Plot_MCYield_VVV_MT[i], uncertainty, nbinMT, Plot_StatUnc_MCYield_VVV_MT[i],Plot_TotUnc_MCYield_VVV_MT[i]);
        AssignUncForPlot_VarBG_NonWZ(Plot_MCYield_VVV_MET[i], uncertainty, nbinMET, Plot_StatUnc_MCYield_VVV_MET[i],Plot_TotUnc_MCYield_VVV_MET[i]);
        AssignUncForPlot_VarBG_NonWZ(Plot_MCYield_VVV_M3l[i], uncertainty, nbinM3l, Plot_StatUnc_MCYield_VVV_M3l[i],Plot_TotUnc_MCYield_VVV_M3l[i]);
        AssignUncForPlot_VarBG_NonWZ(Plot_MCYield_VVV_SumQ[i], uncertainty, nbinSumQ, Plot_StatUnc_MCYield_VVV_SumQ[i],Plot_TotUnc_MCYield_VVV_SumQ[i]);
    ...
    //Original Hists
    outputRootFile=new TFile("FinalYield_VVV.root","CREATE");
    for (int i=0; i<nSRCat; i++) {
        MCYield_VVV[i]->Write();
        MCYield_VVV_JECUp[i]->Write();
        MCYield_VVV_JECDown[i]->Write();
        MCYield_VVV_BTagUp[i]->Write();
        MCYield_VVV_BTagDown[i]->Write();
        MCYield_VVV_LepSFUp[i]->Write();
        MCYield_VVV_LepSFDown[i]->Write();
        MCYield_VVV_PUUp[i]->Write();
        MCYield_VVV_PUDown[i]->Write();
        
        MCYield_VVV_Pt1[i]->Write();
        MCYield_VVV_Pt2[i]->Write();
        MCYield_VVV_Pt3[i]->Write();
        MCYield_VVV_Mll[i]->Write();
        MCYield_VVV_MT[i]->Write();
        MCYield_VVV_MET[i]->Write();
        MCYield_VVV_M3l[i]->Write();
        MCYield_VVV_SumQ[i]->Write();
        
    }
    outputRootFile->Close();
    //For limit setting
    outputRootFile=new TFile("FinalYield_VVV_Limit.root","CREATE");
    for (int i=0; i<nSRCat; i++) {
        MCYield_VVV[i]->Write();
        MCYield_VVV_JECUp[i]->Write();
        MCYield_VVV_JECDown[i]->Write();
    ...
    outputRootFile->Close();
    //For plots
    outputRootFile=new TFile("FinalYield_VVV_Plot.root","CREATE");
    for (int i=0; i<nSRCat; i++) {
        Plot_MCYield_VVV[i]->Write();
        Plot_MCYield_VVV_Pt1[i]->Write();
        Plot_MCYield_VVV_Pt2[i]->Write();
        Plot_MCYield_VVV_Pt3[i]->Write();
        Plot_MCYield_VVV_Mll[i]->Write();
        Plot_MCYield_VVV_MT[i]->Write();
        Plot_MCYield_VVV_MET[i]->Write();
        Plot_MCYield_VVV_M3l[i]->Write();
        Plot_MCYield_VVV_SumQ[i]->Write();
        
        Plot_StatUnc_MCYield_VVV[i]->Write();
        Plot_StatUnc_MCYield_VVV_Pt1[i]->Write();
        Plot_StatUnc_MCYield_VVV_Pt2[i]->Write();
        Plot_StatUnc_MCYield_VVV_Pt3[i]->Write();
        Plot_StatUnc_MCYield_VVV_Mll[i]->Write();
        Plot_StatUnc_MCYield_VVV_MT[i]->Write();
        Plot_StatUnc_MCYield_VVV_MET[i]->Write();
        Plot_StatUnc_MCYield_VVV_M3l[i]->Write();
        Plot_StatUnc_MCYield_VVV_SumQ[i]->Write();
        
        Plot_TotUnc_MCYield_VVV[i]->Write();
        Plot_TotUnc_MCYield_VVV_Pt1[i]->Write();
        Plot_TotUnc_MCYield_VVV_Pt2[i]->Write();
        Plot_TotUnc_MCYield_VVV_Pt3[i]->Write();
        Plot_TotUnc_MCYield_VVV_Mll[i]->Write();
        Plot_TotUnc_MCYield_VVV_MT[i]->Write();
        Plot_TotUnc_MCYield_VVV_MET[i]->Write();
        Plot_TotUnc_MCYield_VVV_M3l[i]->Write();
        Plot_TotUnc_MCYield_VVV_SumQ[i]->Write();
    }
    outputRootFile->Close();
