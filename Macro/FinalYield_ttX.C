...
TString samplefilesMC[nbMCsamples] = {
    "TTWJetsToLNu_skim3Lreco.root",//TTW
    "TTZToLLNuNu_skim3Lreco.root",//TTZToLLNuNu
    "TTZToLL_skim3Lreco.root",//TTZToLL
    "ttHToNonbb_skim3Lreco.root"//ttHToNonbb
};
...
void FinalYield::Loop()
{
    ...
    TH1F* MCYield_ttX[nSRCat];
    TH1F* MCYield_ttX_JECUp[nSRCat];
    TH1F* MCYield_ttX_JECDown[nSRCat];
    TH1F* MCYield_ttX_BTagUp[nSRCat];
    TH1F* MCYield_ttX_BTagDown[nSRCat];
    TH1F* MCYield_ttX_LepSFUp[nSRCat];
    TH1F* MCYield_ttX_LepSFDown[nSRCat];
    TH1F* MCYield_ttX_PUUp[nSRCat];
    TH1F* MCYield_ttX_PUDown[nSRCat];
    
    TH1F* MCYield_ttX_Pt1[nSRCat];
    TH1F* MCYield_ttX_Pt2[nSRCat];
    TH1F* MCYield_ttX_Pt3[nSRCat];
    TH1F* MCYield_ttX_Mll[nSRCat];
    TH1F* MCYield_ttX_MT[nSRCat];
    TH1F* MCYield_ttX_MET[nSRCat];
    TH1F* MCYield_ttX_M3l[nSRCat];
    TH1F* MCYield_ttX_SumQ[nSRCat];
    
    for (int i=0; i<nSRCat; i++) {
        name="MCBG_ttX_"+SRCat[i];
        MCYield_ttX[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_ttX[i]->Sumw2();
        name="MCBG_ttX_JECUp_"+SRCat[i];
        MCYield_ttX_JECUp[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_ttX_JECUp[i]->Sumw2();
        name="MCBG_ttX_JECDown_"+SRCat[i];
        MCYield_ttX_JECDown[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_ttX_JECDown[i]->Sumw2();
        name="MCBG_ttX_BTagUp_"+SRCat[i];
        MCYield_ttX_BTagUp[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_ttX_BTagUp[i]->Sumw2();
        name="MCBG_ttX_BTagDown_"+SRCat[i];
        MCYield_ttX_BTagDown[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_ttX_BTagDown[i]->Sumw2();
        name="MCBG_ttX_LepSFUp_"+SRCat[i];
        MCYield_ttX_LepSFUp[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_ttX_LepSFUp[i]->Sumw2();
        name="MCBG_ttX_LepSFDown_"+SRCat[i];
        MCYield_ttX_LepSFDown[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_ttX_LepSFDown[i]->Sumw2();
        name="MCBG_ttX_PUUp_"+SRCat[i];
        MCYield_ttX_PUUp[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_ttX_PUUp[i]->Sumw2();
        name="MCBG_ttX_PUDown_"+SRCat[i];
        MCYield_ttX_PUDown[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_ttX_PUDown[i]->Sumw2();
        
        name="MCBG_ttX_Pt1_"+SRCat[i];
        MCYield_ttX_Pt1[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        MCYield_ttX_Pt1[i]->Sumw2();
        name="MCBG_ttX_Pt2_"+SRCat[i];
        MCYield_ttX_Pt2[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        MCYield_ttX_Pt2[i]->Sumw2();
        name="MCBG_ttX_Pt3_"+SRCat[i];
        MCYield_ttX_Pt3[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        MCYield_ttX_Pt3[i]->Sumw2();
        name="MCBG_ttX_Mll_"+SRCat[i];
        MCYield_ttX_Mll[i]=new TH1F(name,"",Mllbin[i],Mlllowerbound,Mllupperbound[i]);
        MCYield_ttX_Mll[i]->Sumw2();
        name="MCBG_ttX_MT_"+SRCat[i];
        MCYield_ttX_MT[i]=new TH1F(name,"",MTbin[i],MTlowerbound,MTupperbound[i]);
        MCYield_ttX_MT[i]->Sumw2();
        name="MCBG_ttX_MET_"+SRCat[i];
        MCYield_ttX_MET[i]=new TH1F(name,"",METbin[i],METlowerbound,METupperbound[i]);
        MCYield_ttX_MET[i]->Sumw2();
        name="MCBG_ttX_M3l_"+SRCat[i];
        MCYield_ttX_M3l[i]=new TH1F(name,"",M3lbin[i],M3llowerbound,M3lupperbound[i]);
        MCYield_ttX_M3l[i]->Sumw2();
        name="MCBG_ttX_SumQ_"+SRCat[i];
        MCYield_ttX_SumQ[i]=new TH1F(name,"",SumQbin[i],SumQlowerbound,SumQupperbound[i]);
        MCYield_ttX_SumQ[i]->Sumw2();
    }
            ...
            if (nTau==0) {
                ...
                if (!bJetandMETflag_JECUp) {
                    if (CatA) {
                        ...
                        MCYield_ttX_JECUp[0]->Fill(SRIndex,W);
                    }
                    if (CatB) {
                        SRIndex=CalcSRIndex_B(_met_JECup,Mll,Mt_JECUp);
                        MCYield_ttX_JECUp[1]->Fill(SRIndex,W);
                    }
                }
                //JECDown
                if (!bJetandMETflag_JECDown) {
                    if (CatA) {
                        ...
                        MCYield_ttX_JECDown[0]->Fill(SRIndex,W);
                    }
                    if (CatB) {
                        SRIndex=CalcSRIndex_B(_met_JECdown,Mll,Mt_JECDown);
                        MCYield_ttX_JECDown[1]->Fill(SRIndex,W);
                    }
                }
                //NO JEC
                if (!bJetandMETflag) {
                    ...
                    if (CatA) {
                        ...
                        MCYield_ttX[0]->Fill(SRIndex,W);
                        MCYield_ttX_BTagUp[0]->Fill(SRIndex,W_BTagUp);
                        MCYield_ttX_BTagDown[0]->Fill(SRIndex,W_BTagDown);
                        MCYield_ttX_LepSFUp[0]->Fill(SRIndex,W_LepSFUp);
                        MCYield_ttX_LepSFDown[0]->Fill(SRIndex,W_LepSFDown);
                        MCYield_ttX_PUUp[0]->Fill(SRIndex,W_PUUp);
                        MCYield_ttX_PUDown[0]->Fill(SRIndex,W_PUDown);
                    }
                    if (CatB) {
                        SRIndex=CalcSRIndex_B(_met,Mll,Mt);
                        MCYield_ttX[1]->Fill(SRIndex,W);
                        MCYield_ttX_BTagUp[1]->Fill(SRIndex,W_BTagUp);
                        MCYield_ttX_BTagDown[1]->Fill(SRIndex,W_BTagDown);
                        MCYield_ttX_LepSFUp[1]->Fill(SRIndex,W_LepSFUp);
                        MCYield_ttX_LepSFDown[1]->Fill(SRIndex,W_LepSFDown);
                        MCYield_ttX_PUUp[1]->Fill(SRIndex,W_PUUp);
                        MCYield_ttX_PUDown[1]->Fill(SRIndex,W_PUDown);
                    }
                    ///////////////////////////////////////////////
                    //Fill SR Hist Before Overflow Bin Adjustment//
                    ///////////////////////////////////////////////
                    ...
                    //////FILL HIST////////
                    if (CatA) {
                        MCYield_ttX_Pt1[0]->Fill(leadingPt_FL,W);
                        MCYield_ttX_Pt2[0]->Fill(subleadingPt_FL,W);
                        MCYield_ttX_Pt3[0]->Fill(trailingPt_FL,W);
                        MCYield_ttX_Mll[0]->Fill(Mll_FL,W);
                        MCYield_ttX_MT[0]->Fill(Mt_FL,W);
                        MCYield_ttX_MET[0]->Fill(_met_FL,W);
                        MCYield_ttX_M3l[0]->Fill(M3l_FL,W);
                        MCYield_ttX_SumQ[0]->Fill(SumQ,W);
                    }
                    if (CatB) {
                        MCYield_ttX_Pt1[1]->Fill(leadingPt_FL,W);
                        MCYield_ttX_Pt2[1]->Fill(subleadingPt_FL,W);
                        MCYield_ttX_Pt3[1]->Fill(trailingPt_FL,W);
                        MCYield_ttX_Mll[1]->Fill(Mll_FL,W);
                        MCYield_ttX_MT[1]->Fill(Mt_FL,W);
                        MCYield_ttX_MET[1]->Fill(_met_FL,W);
                        MCYield_ttX_M3l[1]->Fill(M3l_FL,W);
                        MCYield_ttX_SumQ[1]->Fill(SumQ,W);
                    }
            ...
            if (nTau==1) {
                ...
                if (!bJetandMETflag_JECUp) {
                    if (CatC) {
                        ...
                        MCYield_ttX_JECUp[2]->Fill(SRIndex,W);
                    }
                    if (CatD) {
                        SRIndex=CalcSRIndex_D(_met_JECup,Mll,Mt2_JECUp);
                        MCYield_ttX_JECUp[3]->Fill(SRIndex,W);
                    }
                    if (CatE) {
                        SRIndex=CalcSRIndex_E(_met_JECup,Mll,Mt2_JECUp);
                        MCYield_ttX_JECUp[4]->Fill(SRIndex,W);
                    }
                }
                //JECDown
                if (!bJetandMETflag_JECDown) {
                    if (CatC) {
                        ...
                        MCYield_ttX_JECDown[2]->Fill(SRIndex,W);
                    }
                    if (CatD) {
                        SRIndex=CalcSRIndex_D(_met_JECdown,Mll,Mt2_JECDown);
                        MCYield_ttX_JECDown[3]->Fill(SRIndex,W);
                    }
                    if (CatE) {
                        SRIndex=CalcSRIndex_E(_met_JECdown,Mll,Mt2_JECDown);
                        MCYield_ttX_JECDown[4]->Fill(SRIndex,W);
                    }
                }
                //NO JEC
                if (!bJetandMETflag) {
                    ...
                    if (CatC) {
                        ...
                        MCYield_ttX[2]->Fill(SRIndex,W);
                        MCYield_ttX_BTagUp[2]->Fill(SRIndex,W_BTagUp);
                        MCYield_ttX_BTagDown[2]->Fill(SRIndex,W_BTagDown);
                        MCYield_ttX_LepSFUp[2]->Fill(SRIndex,W_LepSFUp);
                        MCYield_ttX_LepSFDown[2]->Fill(SRIndex,W_LepSFDown);
                        MCYield_ttX_PUUp[2]->Fill(SRIndex,W_PUUp);
                        MCYield_ttX_PUDown[2]->Fill(SRIndex,W_PUDown);
                    }
                    if (CatD) {
                        SRIndex=CalcSRIndex_D(_met,Mll,Mt2);
                        MCYield_ttX[3]->Fill(SRIndex,W);
                        MCYield_ttX_BTagUp[3]->Fill(SRIndex,W_BTagUp);
                        MCYield_ttX_BTagDown[3]->Fill(SRIndex,W_BTagDown);
                        MCYield_ttX_LepSFUp[3]->Fill(SRIndex,W_LepSFUp);
                        MCYield_ttX_LepSFDown[3]->Fill(SRIndex,W_LepSFDown);
                        MCYield_ttX_PUUp[3]->Fill(SRIndex,W_PUUp);
                        MCYield_ttX_PUDown[3]->Fill(SRIndex,W_PUDown);
                    }
                    if (CatE) {
                        SRIndex=CalcSRIndex_E(_met,Mll,Mt2);
                        MCYield_ttX[4]->Fill(SRIndex,W);
                        MCYield_ttX_BTagUp[4]->Fill(SRIndex,W_BTagUp);
                        MCYield_ttX_BTagDown[4]->Fill(SRIndex,W_BTagDown);
                        MCYield_ttX_LepSFUp[4]->Fill(SRIndex,W_LepSFUp);
                        MCYield_ttX_LepSFDown[4]->Fill(SRIndex,W_LepSFDown);
                        MCYield_ttX_PUUp[4]->Fill(SRIndex,W_PUUp);
                        MCYield_ttX_PUDown[4]->Fill(SRIndex,W_PUDown);
                    }
                    ///////////////////////////////////////////////
                    //Fill SR Hist Before Overflow Bin Adjustment//
                    ///////////////////////////////////////////////
                    ...
                    if (CatC) {
                        MCYield_ttX_Pt1[2]->Fill(leadingPt_FL,W);
                        MCYield_ttX_Pt2[2]->Fill(subleadingPt_FL,W);
                        MCYield_ttX_Pt3[2]->Fill(trailingPt_FL,W);
                        MCYield_ttX_Mll[2]->Fill(Mll_FL,W);
                        MCYield_ttX_MT[2]->Fill(Mt2_FL,W);
                        MCYield_ttX_MET[2]->Fill(_met_FL,W);
                        MCYield_ttX_M3l[2]->Fill(M3l_FL,W);
                        MCYield_ttX_SumQ[2]->Fill(SumQ,W);
                    }
                    if (CatD) {
                        MCYield_ttX_Pt1[3]->Fill(leadingPt_FL,W);
                        MCYield_ttX_Pt2[3]->Fill(subleadingPt_FL,W);
                        MCYield_ttX_Pt3[3]->Fill(trailingPt_FL,W);
                        MCYield_ttX_Mll[3]->Fill(Mll_FL,W);
                        MCYield_ttX_MT[3]->Fill(Mt2_FL,W);
                        MCYield_ttX_MET[3]->Fill(_met_FL,W);
                        MCYield_ttX_M3l[3]->Fill(M3l_FL,W);
                        MCYield_ttX_SumQ[3]->Fill(SumQ,W);
                    }
                    if (CatE) {
                        MCYield_ttX_Pt1[4]->Fill(leadingPt_FL,W);
                        MCYield_ttX_Pt2[4]->Fill(subleadingPt_FL,W);
                        MCYield_ttX_Pt3[4]->Fill(trailingPt_FL,W);
                        MCYield_ttX_Mll[4]->Fill(Mll_FL,W);
                        MCYield_ttX_MT[4]->Fill(Mt2_FL,W);
                        MCYield_ttX_MET[4]->Fill(_met_FL,W);
                        MCYield_ttX_M3l[4]->Fill(M3l_FL,W);
                        MCYield_ttX_SumQ[4]->Fill(SumQ,W);
                    }
                }//NO JEC
            ...
            if (nTau==2) {
                ...
                if (!bJetandMETflag_JECUp) {
                    if (CatF) {
                        ...
                        MCYield_ttX_JECUp[5]->Fill(SRIndex,W);
                    }
                }
                //JECDown
                if (!bJetandMETflag_JECDown) {
                    if (CatF) {
                        ...
                        MCYield_ttX_JECDown[5]->Fill(SRIndex,W);
                    }
                }
                //NO JEC
                if (!bJetandMETflag) {
                    ...
                    if (CatF) {
                        ...
                        MCYield_ttX[5]->Fill(SRIndex,W);
                        MCYield_ttX_BTagUp[5]->Fill(SRIndex,W_BTagUp);
                        MCYield_ttX_BTagDown[5]->Fill(SRIndex,W_BTagDown);
                        MCYield_ttX_LepSFUp[5]->Fill(SRIndex,W_LepSFUp);
                        MCYield_ttX_LepSFDown[5]->Fill(SRIndex,W_LepSFDown);
                        MCYield_ttX_PUUp[5]->Fill(SRIndex,W_PUUp);
                        MCYield_ttX_PUDown[5]->Fill(SRIndex,W_PUDown);
                    }
                    ///////////////////////////////////////////////
                    //Fill SR Hist Before Overflow Bin Adjustment//
                    ///////////////////////////////////////////////
                    ...
                    if (CatF) {
                        MCYield_ttX_Pt1[5]->Fill(leadingPt_FL,W);
                        MCYield_ttX_Pt2[5]->Fill(subleadingPt_FL,W);
                        MCYield_ttX_Pt3[5]->Fill(trailingPt_FL,W);
                        MCYield_ttX_Mll[5]->Fill(Mll_FL,W);
                        MCYield_ttX_MT[5]->Fill(Mt2_FL,W);
                        MCYield_ttX_MET[5]->Fill(_met_FL,W);
                        MCYield_ttX_M3l[5]->Fill(M3l_FL,W);
                        MCYield_ttX_SumQ[5]->Fill(SumQ,W);
                    }
                }//NO JEC
    ...
    //Hists for plots
    TH1F* Plot_MCYield_ttX[nSRCat];
    TH1F* Plot_MCYield_ttX_Pt1[nSRCat];
    TH1F* Plot_MCYield_ttX_Pt2[nSRCat];
    TH1F* Plot_MCYield_ttX_Pt3[nSRCat];
    TH1F* Plot_MCYield_ttX_Mll[nSRCat];
    TH1F* Plot_MCYield_ttX_MT[nSRCat];
    TH1F* Plot_MCYield_ttX_MET[nSRCat];
    TH1F* Plot_MCYield_ttX_M3l[nSRCat];
    TH1F* Plot_MCYield_ttX_SumQ[nSRCat];
    
    TH1F* Plot_StatUnc_MCYield_ttX[nSRCat];
    TH1F* Plot_StatUnc_MCYield_ttX_Pt1[nSRCat];
    TH1F* Plot_StatUnc_MCYield_ttX_Pt2[nSRCat];
    TH1F* Plot_StatUnc_MCYield_ttX_Pt3[nSRCat];
    TH1F* Plot_StatUnc_MCYield_ttX_Mll[nSRCat];
    TH1F* Plot_StatUnc_MCYield_ttX_MT[nSRCat];
    TH1F* Plot_StatUnc_MCYield_ttX_MET[nSRCat];
    TH1F* Plot_StatUnc_MCYield_ttX_M3l[nSRCat];
    TH1F* Plot_StatUnc_MCYield_ttX_SumQ[nSRCat];
    
    TH1F* Plot_TotUnc_MCYield_ttX[nSRCat];
    TH1F* Plot_TotUnc_MCYield_ttX_Pt1[nSRCat];
    TH1F* Plot_TotUnc_MCYield_ttX_Pt2[nSRCat];
    TH1F* Plot_TotUnc_MCYield_ttX_Pt3[nSRCat];
    TH1F* Plot_TotUnc_MCYield_ttX_Mll[nSRCat];
    TH1F* Plot_TotUnc_MCYield_ttX_MT[nSRCat];
    TH1F* Plot_TotUnc_MCYield_ttX_MET[nSRCat];
    TH1F* Plot_TotUnc_MCYield_ttX_M3l[nSRCat];
    TH1F* Plot_TotUnc_MCYield_ttX_SumQ[nSRCat];
    //Hists for plots
    
    for (int i=0; i<nSRCat; i++) {
        
        Plot_MCYield_ttX[i]=(TH1F*)MCYield_ttX[i]->Clone();
        Plot_MCYield_ttX_Pt1[i]=(TH1F*)MCYield_ttX_Pt1[i]->Clone();
        Plot_MCYield_ttX_Pt2[i]=(TH1F*)MCYield_ttX_Pt2[i]->Clone();
        Plot_MCYield_ttX_Pt3[i]=(TH1F*)MCYield_ttX_Pt3[i]->Clone();
        Plot_MCYield_ttX_Mll[i]=(TH1F*)MCYield_ttX_Mll[i]->Clone();
        Plot_MCYield_ttX_MT[i]=(TH1F*)MCYield_ttX_MT[i]->Clone();
        Plot_MCYield_ttX_MET[i]=(TH1F*)MCYield_ttX_MET[i]->Clone();
        Plot_MCYield_ttX_M3l[i]=(TH1F*)MCYield_ttX_M3l[i]->Clone();
        Plot_MCYield_ttX_SumQ[i]=(TH1F*)MCYield_ttX_SumQ[i]->Clone();
        
        name="Plot_StatUnc_MCBG_ttX_"+SRCat[i];
        Plot_StatUnc_MCYield_ttX[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        Plot_StatUnc_MCYield_ttX[i]->Sumw2();
        name="Plot_StatUnc_MCBG_ttX_Pt1_"+SRCat[i];
        Plot_StatUnc_MCYield_ttX_Pt1[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        Plot_StatUnc_MCYield_ttX_Pt1[i]->Sumw2();
        name="Plot_StatUnc_MCBG_ttX_Pt2_"+SRCat[i];
        Plot_StatUnc_MCYield_ttX_Pt2[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        Plot_StatUnc_MCYield_ttX_Pt2[i]->Sumw2();
        name="Plot_StatUnc_MCBG_ttX_Pt3_"+SRCat[i];
        Plot_StatUnc_MCYield_ttX_Pt3[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        Plot_StatUnc_MCYield_ttX_Pt3[i]->Sumw2();
        name="Plot_StatUnc_MCBG_ttX_Mll_"+SRCat[i];
        Plot_StatUnc_MCYield_ttX_Mll[i]=new TH1F(name,"",Mllbin[i],Mlllowerbound,Mllupperbound[i]);
        Plot_StatUnc_MCYield_ttX_Mll[i]->Sumw2();
        name="Plot_StatUnc_MCBG_ttX_MT_"+SRCat[i];
        Plot_StatUnc_MCYield_ttX_MT[i]=new TH1F(name,"",MTbin[i],MTlowerbound,MTupperbound[i]);
        Plot_StatUnc_MCYield_ttX_MT[i]->Sumw2();
        name="Plot_StatUnc_MCBG_ttX_MET_"+SRCat[i];
        Plot_StatUnc_MCYield_ttX_MET[i]=new TH1F(name,"",METbin[i],METlowerbound,METupperbound[i]);
        Plot_StatUnc_MCYield_ttX_MET[i]->Sumw2();
        name="Plot_StatUnc_MCBG_ttX_M3l_"+SRCat[i];
        Plot_StatUnc_MCYield_ttX_M3l[i]=new TH1F(name,"",M3lbin[i],M3llowerbound,M3lupperbound[i]);
        Plot_StatUnc_MCYield_ttX_M3l[i]->Sumw2();
        name="Plot_StatUnc_MCBG_ttX_SumQ_"+SRCat[i];
        Plot_StatUnc_MCYield_ttX_SumQ[i]=new TH1F(name,"",SumQbin[i],SumQlowerbound,SumQupperbound[i]);
        Plot_StatUnc_MCYield_ttX_SumQ[i]->Sumw2();
        
        name="Plot_TotUnc_MCBG_ttX_"+SRCat[i];
        Plot_TotUnc_MCYield_ttX[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        Plot_TotUnc_MCYield_ttX[i]->Sumw2();
        name="Plot_TotUnc_MCBG_ttX_Pt1_"+SRCat[i];
        Plot_TotUnc_MCYield_ttX_Pt1[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        Plot_TotUnc_MCYield_ttX_Pt1[i]->Sumw2();
        name="Plot_TotUnc_MCBG_ttX_Pt2_"+SRCat[i];
        Plot_TotUnc_MCYield_ttX_Pt2[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        Plot_TotUnc_MCYield_ttX_Pt2[i]->Sumw2();
        name="Plot_TotUnc_MCBG_ttX_Pt3_"+SRCat[i];
        Plot_TotUnc_MCYield_ttX_Pt3[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        Plot_TotUnc_MCYield_ttX_Pt3[i]->Sumw2();
        name="Plot_TotUnc_MCBG_ttX_Mll_"+SRCat[i];
        Plot_TotUnc_MCYield_ttX_Mll[i]=new TH1F(name,"",Mllbin[i],Mlllowerbound,Mllupperbound[i]);
        Plot_TotUnc_MCYield_ttX_Mll[i]->Sumw2();
        name="Plot_TotUnc_MCBG_ttX_MT_"+SRCat[i];
        Plot_TotUnc_MCYield_ttX_MT[i]=new TH1F(name,"",MTbin[i],MTlowerbound,MTupperbound[i]);
        Plot_TotUnc_MCYield_ttX_MT[i]->Sumw2();
        name="Plot_TotUnc_MCBG_ttX_MET_"+SRCat[i];
        Plot_TotUnc_MCYield_ttX_MET[i]=new TH1F(name,"",METbin[i],METlowerbound,METupperbound[i]);
        Plot_TotUnc_MCYield_ttX_MET[i]->Sumw2();
        name="Plot_TotUnc_MCBG_ttX_M3l_"+SRCat[i];
        Plot_TotUnc_MCYield_ttX_M3l[i]=new TH1F(name,"",M3lbin[i],M3llowerbound,M3lupperbound[i]);
        Plot_TotUnc_MCYield_ttX_M3l[i]->Sumw2();
        name="Plot_TotUnc_MCBG_ttX_SumQ_"+SRCat[i];
        Plot_TotUnc_MCYield_ttX_SumQ[i]=new TH1F(name,"",SumQbin[i],SumQlowerbound,SumQupperbound[i]);
        Plot_TotUnc_MCYield_ttX_SumQ[i]->Sumw2();
    }
    ...
    for (int i=0; i<nSRCat; i++) {
         ...
         */
        //SR
        AssignUncForPlot_SRBG_NonWZ(Plot_MCYield_ttX[i], uncertainty, nbinSR, MCYield_ttX_JECUp[i], MCYield_ttX_JECDown[i], MCYield_ttX_BTagUp[i],MCYield_ttX_BTagDown[i],MCYield_ttX_LepSFUp[i],MCYield_ttX_LepSFDown[i],MCYield_ttX_PUUp[i],MCYield_ttX_PUDown[i],Plot_StatUnc_MCYield_ttX[i],Plot_TotUnc_MCYield_ttX[i]);
        //Var
        AssignUncForPlot_VarBG_NonWZ(Plot_MCYield_ttX_Pt1[i], uncertainty, nbinPt, Plot_StatUnc_MCYield_ttX_Pt1[i],Plot_TotUnc_MCYield_ttX_Pt1[i]);
        AssignUncForPlot_VarBG_NonWZ(Plot_MCYield_ttX_Pt2[i], uncertainty, nbinPt, Plot_StatUnc_MCYield_ttX_Pt2[i],Plot_TotUnc_MCYield_ttX_Pt2[i]);
        AssignUncForPlot_VarBG_NonWZ(Plot_MCYield_ttX_Pt3[i], uncertainty, nbinPt, Plot_StatUnc_MCYield_ttX_Pt3[i],Plot_TotUnc_MCYield_ttX_Pt3[i]);
        AssignUncForPlot_VarBG_NonWZ(Plot_MCYield_ttX_Mll[i], uncertainty, nbinMll, Plot_StatUnc_MCYield_ttX_Mll[i],Plot_TotUnc_MCYield_ttX_Mll[i]);
        AssignUncForPlot_VarBG_NonWZ(Plot_MCYield_ttX_MT[i], uncertainty, nbinMT, Plot_StatUnc_MCYield_ttX_MT[i],Plot_TotUnc_MCYield_ttX_MT[i]);
        AssignUncForPlot_VarBG_NonWZ(Plot_MCYield_ttX_MET[i], uncertainty, nbinMET, Plot_StatUnc_MCYield_ttX_MET[i],Plot_TotUnc_MCYield_ttX_MET[i]);
        AssignUncForPlot_VarBG_NonWZ(Plot_MCYield_ttX_M3l[i], uncertainty, nbinM3l, Plot_StatUnc_MCYield_ttX_M3l[i],Plot_TotUnc_MCYield_ttX_M3l[i]);
        AssignUncForPlot_VarBG_NonWZ(Plot_MCYield_ttX_SumQ[i], uncertainty, nbinSumQ, Plot_StatUnc_MCYield_ttX_SumQ[i],Plot_TotUnc_MCYield_ttX_SumQ[i]);
    ...
    //Original Hists
    outputRootFile=new TFile("FinalYield_ttX.root","CREATE");
    for (int i=0; i<nSRCat; i++) {
        MCYield_ttX[i]->Write();
        MCYield_ttX_JECUp[i]->Write();
        MCYield_ttX_JECDown[i]->Write();
        MCYield_ttX_BTagUp[i]->Write();
        MCYield_ttX_BTagDown[i]->Write();
        MCYield_ttX_LepSFUp[i]->Write();
        MCYield_ttX_LepSFDown[i]->Write();
        MCYield_ttX_PUUp[i]->Write();
        MCYield_ttX_PUDown[i]->Write();
        
        MCYield_ttX_Pt1[i]->Write();
        MCYield_ttX_Pt2[i]->Write();
        MCYield_ttX_Pt3[i]->Write();
        MCYield_ttX_Mll[i]->Write();
        MCYield_ttX_MT[i]->Write();
        MCYield_ttX_MET[i]->Write();
        MCYield_ttX_M3l[i]->Write();
        MCYield_ttX_SumQ[i]->Write();
        
    }
    outputRootFile->Close();
    //For limit setting
    outputRootFile=new TFile("FinalYield_ttX_Limit.root","CREATE");
    for (int i=0; i<nSRCat; i++) {
        MCYield_ttX[i]->Write();
        MCYield_ttX_JECUp[i]->Write();
        MCYield_ttX_JECDown[i]->Write();
    ...
    outputRootFile->Close();
    //For plots
    outputRootFile=new TFile("FinalYield_ttX_Plot.root","CREATE");
    for (int i=0; i<nSRCat; i++) {
        Plot_MCYield_ttX[i]->Write();
        Plot_MCYield_ttX_Pt1[i]->Write();
        Plot_MCYield_ttX_Pt2[i]->Write();
        Plot_MCYield_ttX_Pt3[i]->Write();
        Plot_MCYield_ttX_Mll[i]->Write();
        Plot_MCYield_ttX_MT[i]->Write();
        Plot_MCYield_ttX_MET[i]->Write();
        Plot_MCYield_ttX_M3l[i]->Write();
        Plot_MCYield_ttX_SumQ[i]->Write();
        
        Plot_StatUnc_MCYield_ttX[i]->Write();
        Plot_StatUnc_MCYield_ttX_Pt1[i]->Write();
        Plot_StatUnc_MCYield_ttX_Pt2[i]->Write();
        Plot_StatUnc_MCYield_ttX_Pt3[i]->Write();
        Plot_StatUnc_MCYield_ttX_Mll[i]->Write();
        Plot_StatUnc_MCYield_ttX_MT[i]->Write();
        Plot_StatUnc_MCYield_ttX_MET[i]->Write();
        Plot_StatUnc_MCYield_ttX_M3l[i]->Write();
        Plot_StatUnc_MCYield_ttX_SumQ[i]->Write();
        
        Plot_TotUnc_MCYield_ttX[i]->Write();
        Plot_TotUnc_MCYield_ttX_Pt1[i]->Write();
        Plot_TotUnc_MCYield_ttX_Pt2[i]->Write();
        Plot_TotUnc_MCYield_ttX_Pt3[i]->Write();
        Plot_TotUnc_MCYield_ttX_Mll[i]->Write();
        Plot_TotUnc_MCYield_ttX_MT[i]->Write();
        Plot_TotUnc_MCYield_ttX_MET[i]->Write();
        Plot_TotUnc_MCYield_ttX_M3l[i]->Write();
        Plot_TotUnc_MCYield_ttX_SumQ[i]->Write();
    }
    outputRootFile->Close();
