...
TString samplefilesMC[nbMCsamples] = {
    "ZZTo4L_skim3Lreco.root",//ZZ/H
    "GluGluHToZZTo4L_skim3Lreco.root"//GluGluHToZZTo4L
};
...
void FinalYield::Loop()
{
    ...
    TH1F* MCYield_ZZ[nSRCat];
    TH1F* MCYield_ZZ_JECUp[nSRCat];
    TH1F* MCYield_ZZ_JECDown[nSRCat];
    TH1F* MCYield_ZZ_BTagUp[nSRCat];
    TH1F* MCYield_ZZ_BTagDown[nSRCat];
    TH1F* MCYield_ZZ_LepSFUp[nSRCat];
    TH1F* MCYield_ZZ_LepSFDown[nSRCat];
    TH1F* MCYield_ZZ_PUUp[nSRCat];
    TH1F* MCYield_ZZ_PUDown[nSRCat];
    
    TH1F* MCYield_ZZ_Pt1[nSRCat];
    TH1F* MCYield_ZZ_Pt2[nSRCat];
    TH1F* MCYield_ZZ_Pt3[nSRCat];
    TH1F* MCYield_ZZ_Mll[nSRCat];
    TH1F* MCYield_ZZ_MT[nSRCat];
    TH1F* MCYield_ZZ_MET[nSRCat];
    TH1F* MCYield_ZZ_M3l[nSRCat];
    TH1F* MCYield_ZZ_SumQ[nSRCat];
    
    for (int i=0; i<nSRCat; i++) {
        name="MCBG_ZZ_"+SRCat[i];
        MCYield_ZZ[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_ZZ[i]->Sumw2();
        name="MCBG_ZZ_JECUp_"+SRCat[i];
        MCYield_ZZ_JECUp[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_ZZ_JECUp[i]->Sumw2();
        name="MCBG_ZZ_JECDown_"+SRCat[i];
        MCYield_ZZ_JECDown[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_ZZ_JECDown[i]->Sumw2();
        name="MCBG_ZZ_BTagUp_"+SRCat[i];
        MCYield_ZZ_BTagUp[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_ZZ_BTagUp[i]->Sumw2();
        name="MCBG_ZZ_BTagDown_"+SRCat[i];
        MCYield_ZZ_BTagDown[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_ZZ_BTagDown[i]->Sumw2();
        name="MCBG_ZZ_LepSFUp_"+SRCat[i];
        MCYield_ZZ_LepSFUp[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_ZZ_LepSFUp[i]->Sumw2();
        name="MCBG_ZZ_LepSFDown_"+SRCat[i];
        MCYield_ZZ_LepSFDown[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_ZZ_LepSFDown[i]->Sumw2();
        name="MCBG_ZZ_PUUp_"+SRCat[i];
        MCYield_ZZ_PUUp[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_ZZ_PUUp[i]->Sumw2();
        name="MCBG_ZZ_PUDown_"+SRCat[i];
        MCYield_ZZ_PUDown[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_ZZ_PUDown[i]->Sumw2();
        
        name="MCBG_ZZ_Pt1_"+SRCat[i];
        MCYield_ZZ_Pt1[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        MCYield_ZZ_Pt1[i]->Sumw2();
        name="MCBG_ZZ_Pt2_"+SRCat[i];
        MCYield_ZZ_Pt2[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        MCYield_ZZ_Pt2[i]->Sumw2();
        name="MCBG_ZZ_Pt3_"+SRCat[i];
        MCYield_ZZ_Pt3[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        MCYield_ZZ_Pt3[i]->Sumw2();
        name="MCBG_ZZ_Mll_"+SRCat[i];
        MCYield_ZZ_Mll[i]=new TH1F(name,"",Mllbin[i],Mlllowerbound,Mllupperbound[i]);
        MCYield_ZZ_Mll[i]->Sumw2();
        name="MCBG_ZZ_MT_"+SRCat[i];
        MCYield_ZZ_MT[i]=new TH1F(name,"",MTbin[i],MTlowerbound,MTupperbound[i]);
        MCYield_ZZ_MT[i]->Sumw2();
        name="MCBG_ZZ_MET_"+SRCat[i];
        MCYield_ZZ_MET[i]=new TH1F(name,"",METbin[i],METlowerbound,METupperbound[i]);
        MCYield_ZZ_MET[i]->Sumw2();
        name="MCBG_ZZ_M3l_"+SRCat[i];
        MCYield_ZZ_M3l[i]=new TH1F(name,"",M3lbin[i],M3llowerbound,M3lupperbound[i]);
        MCYield_ZZ_M3l[i]->Sumw2();
        name="MCBG_ZZ_SumQ_"+SRCat[i];
        MCYield_ZZ_SumQ[i]=new TH1F(name,"",SumQbin[i],SumQlowerbound,SumQupperbound[i]);
        MCYield_ZZ_SumQ[i]->Sumw2();
    }
            ...
            if (nTau==0) {
                ...
                if (!bJetandMETflag_JECUp) {
                    if (CatA) {
                        ...
                        MCYield_ZZ_JECUp[0]->Fill(SRIndex,W);
                    }
                    if (CatB) {
                        SRIndex=CalcSRIndex_B(_met_JECup,Mll,Mt_JECUp);
                        MCYield_ZZ_JECUp[1]->Fill(SRIndex,W);
                    }
                }
                //JECDown
                if (!bJetandMETflag_JECDown) {
                    if (CatA) {
                        ...
                        MCYield_ZZ_JECDown[0]->Fill(SRIndex,W);
                    }
                    if (CatB) {
                        SRIndex=CalcSRIndex_B(_met_JECdown,Mll,Mt_JECDown);
                        MCYield_ZZ_JECDown[1]->Fill(SRIndex,W);
                    }
                }
                //NO JEC
                if (!bJetandMETflag) {
                    ...
                    if (CatA) {
                        ...
                        MCYield_ZZ[0]->Fill(SRIndex,W);
                        MCYield_ZZ_BTagUp[0]->Fill(SRIndex,W_BTagUp);
                        MCYield_ZZ_BTagDown[0]->Fill(SRIndex,W_BTagDown);
                        MCYield_ZZ_LepSFUp[0]->Fill(SRIndex,W_LepSFUp);
                        MCYield_ZZ_LepSFDown[0]->Fill(SRIndex,W_LepSFDown);
                        MCYield_ZZ_PUUp[0]->Fill(SRIndex,W_PUUp);
                        MCYield_ZZ_PUDown[0]->Fill(SRIndex,W_PUDown);
                    }
                    if (CatB) {
                        SRIndex=CalcSRIndex_B(_met,Mll,Mt);
                        MCYield_ZZ[1]->Fill(SRIndex,W);
                        MCYield_ZZ_BTagUp[1]->Fill(SRIndex,W_BTagUp);
                        MCYield_ZZ_BTagDown[1]->Fill(SRIndex,W_BTagDown);
                        MCYield_ZZ_LepSFUp[1]->Fill(SRIndex,W_LepSFUp);
                        MCYield_ZZ_LepSFDown[1]->Fill(SRIndex,W_LepSFDown);
                        MCYield_ZZ_PUUp[1]->Fill(SRIndex,W_PUUp);
                        MCYield_ZZ_PUDown[1]->Fill(SRIndex,W_PUDown);
                    }
                    ///////////////////////////////////////////////
                    //Fill SR Hist Before Overflow Bin Adjustment//
                    ///////////////////////////////////////////////
                    ...
                    //////FILL HIST////////
                    if (CatA) {
                        MCYield_ZZ_Pt1[0]->Fill(leadingPt_FL,W);
                        MCYield_ZZ_Pt2[0]->Fill(subleadingPt_FL,W);
                        MCYield_ZZ_Pt3[0]->Fill(trailingPt_FL,W);
                        MCYield_ZZ_Mll[0]->Fill(Mll_FL,W);
                        MCYield_ZZ_MT[0]->Fill(Mt_FL,W);
                        MCYield_ZZ_MET[0]->Fill(_met_FL,W);
                        MCYield_ZZ_M3l[0]->Fill(M3l_FL,W);
                        MCYield_ZZ_SumQ[0]->Fill(SumQ,W);
                    }
                    if (CatB) {
                        MCYield_ZZ_Pt1[1]->Fill(leadingPt_FL,W);
                        MCYield_ZZ_Pt2[1]->Fill(subleadingPt_FL,W);
                        MCYield_ZZ_Pt3[1]->Fill(trailingPt_FL,W);
                        MCYield_ZZ_Mll[1]->Fill(Mll_FL,W);
                        MCYield_ZZ_MT[1]->Fill(Mt_FL,W);
                        MCYield_ZZ_MET[1]->Fill(_met_FL,W);
                        MCYield_ZZ_M3l[1]->Fill(M3l_FL,W);
                        MCYield_ZZ_SumQ[1]->Fill(SumQ,W);
                    }
            ...
            if (nTau==1) {
                ...
                if (!bJetandMETflag_JECUp) {
                    if (CatC) {
                        ...
                        MCYield_ZZ_JECUp[2]->Fill(SRIndex,W);
                    }
                    if (CatD) {
                        SRIndex=CalcSRIndex_D(_met_JECup,Mll,Mt2_JECUp);
                        MCYield_ZZ_JECUp[3]->Fill(SRIndex,W);
                    }
                    if (CatE) {
                        SRIndex=CalcSRIndex_E(_met_JECup,Mll,Mt2_JECUp);
                        MCYield_ZZ_JECUp[4]->Fill(SRIndex,W);
                    }
                }
                //JECDown
                if (!bJetandMETflag_JECDown) {
                    if (CatC) {
                        ...
                        MCYield_ZZ_JECDown[2]->Fill(SRIndex,W);
                    }
                    if (CatD) {
                        SRIndex=CalcSRIndex_D(_met_JECdown,Mll,Mt2_JECDown);
                        MCYield_ZZ_JECDown[3]->Fill(SRIndex,W);
                    }
                    if (CatE) {
                        SRIndex=CalcSRIndex_E(_met_JECdown,Mll,Mt2_JECDown);
                        MCYield_ZZ_JECDown[4]->Fill(SRIndex,W);
                    }
                }
                //NO JEC
                if (!bJetandMETflag) {
                    ...
                    if (CatC) {
                        ...
                        MCYield_ZZ[2]->Fill(SRIndex,W);
                        MCYield_ZZ_BTagUp[2]->Fill(SRIndex,W_BTagUp);
                        MCYield_ZZ_BTagDown[2]->Fill(SRIndex,W_BTagDown);
                        MCYield_ZZ_LepSFUp[2]->Fill(SRIndex,W_LepSFUp);
                        MCYield_ZZ_LepSFDown[2]->Fill(SRIndex,W_LepSFDown);
                        MCYield_ZZ_PUUp[2]->Fill(SRIndex,W_PUUp);
                        MCYield_ZZ_PUDown[2]->Fill(SRIndex,W_PUDown);
                    }
                    if (CatD) {
                        SRIndex=CalcSRIndex_D(_met,Mll,Mt2);
                        MCYield_ZZ[3]->Fill(SRIndex,W);
                        MCYield_ZZ_BTagUp[3]->Fill(SRIndex,W_BTagUp);
                        MCYield_ZZ_BTagDown[3]->Fill(SRIndex,W_BTagDown);
                        MCYield_ZZ_LepSFUp[3]->Fill(SRIndex,W_LepSFUp);
                        MCYield_ZZ_LepSFDown[3]->Fill(SRIndex,W_LepSFDown);
                        MCYield_ZZ_PUUp[3]->Fill(SRIndex,W_PUUp);
                        MCYield_ZZ_PUDown[3]->Fill(SRIndex,W_PUDown);
                    }
                    if (CatE) {
                        SRIndex=CalcSRIndex_E(_met,Mll,Mt2);
                        MCYield_ZZ[4]->Fill(SRIndex,W);
                        MCYield_ZZ_BTagUp[4]->Fill(SRIndex,W_BTagUp);
                        MCYield_ZZ_BTagDown[4]->Fill(SRIndex,W_BTagDown);
                        MCYield_ZZ_LepSFUp[4]->Fill(SRIndex,W_LepSFUp);
                        MCYield_ZZ_LepSFDown[4]->Fill(SRIndex,W_LepSFDown);
                        MCYield_ZZ_PUUp[4]->Fill(SRIndex,W_PUUp);
                        MCYield_ZZ_PUDown[4]->Fill(SRIndex,W_PUDown);
                    }
                    ///////////////////////////////////////////////
                    //Fill SR Hist Before Overflow Bin Adjustment//
                    ///////////////////////////////////////////////
                    ...
                    if (CatC) {
                        MCYield_ZZ_Pt1[2]->Fill(leadingPt_FL,W);
                        MCYield_ZZ_Pt2[2]->Fill(subleadingPt_FL,W);
                        MCYield_ZZ_Pt3[2]->Fill(trailingPt_FL,W);
                        MCYield_ZZ_Mll[2]->Fill(Mll_FL,W);
                        MCYield_ZZ_MT[2]->Fill(Mt2_FL,W);
                        MCYield_ZZ_MET[2]->Fill(_met_FL,W);
                        MCYield_ZZ_M3l[2]->Fill(M3l_FL,W);
                        MCYield_ZZ_SumQ[2]->Fill(SumQ,W);
                    }
                    if (CatD) {
                        MCYield_ZZ_Pt1[3]->Fill(leadingPt_FL,W);
                        MCYield_ZZ_Pt2[3]->Fill(subleadingPt_FL,W);
                        MCYield_ZZ_Pt3[3]->Fill(trailingPt_FL,W);
                        MCYield_ZZ_Mll[3]->Fill(Mll_FL,W);
                        MCYield_ZZ_MT[3]->Fill(Mt2_FL,W);
                        MCYield_ZZ_MET[3]->Fill(_met_FL,W);
                        MCYield_ZZ_M3l[3]->Fill(M3l_FL,W);
                        MCYield_ZZ_SumQ[3]->Fill(SumQ,W);
                    }
                    if (CatE) {
                        MCYield_ZZ_Pt1[4]->Fill(leadingPt_FL,W);
                        MCYield_ZZ_Pt2[4]->Fill(subleadingPt_FL,W);
                        MCYield_ZZ_Pt3[4]->Fill(trailingPt_FL,W);
                        MCYield_ZZ_Mll[4]->Fill(Mll_FL,W);
                        MCYield_ZZ_MT[4]->Fill(Mt2_FL,W);
                        MCYield_ZZ_MET[4]->Fill(_met_FL,W);
                        MCYield_ZZ_M3l[4]->Fill(M3l_FL,W);
                        MCYield_ZZ_SumQ[4]->Fill(SumQ,W);
                    }
                }//NO JEC
            ...
            if (nTau==2) {
                ...
                if (!bJetandMETflag_JECUp) {
                    if (CatF) {
                        ...
                        MCYield_ZZ_JECUp[5]->Fill(SRIndex,W);
                    }
                }
                //JECDown
                if (!bJetandMETflag_JECDown) {
                    if (CatF) {
                        ...
                        MCYield_ZZ_JECDown[5]->Fill(SRIndex,W);
                    }
                }
                //NO JEC
                if (!bJetandMETflag) {
                    ...
                    if (CatF) {
                        ...
                        MCYield_ZZ[5]->Fill(SRIndex,W);
                        MCYield_ZZ_BTagUp[5]->Fill(SRIndex,W_BTagUp);
                        MCYield_ZZ_BTagDown[5]->Fill(SRIndex,W_BTagDown);
                        MCYield_ZZ_LepSFUp[5]->Fill(SRIndex,W_LepSFUp);
                        MCYield_ZZ_LepSFDown[5]->Fill(SRIndex,W_LepSFDown);
                        MCYield_ZZ_PUUp[5]->Fill(SRIndex,W_PUUp);
                        MCYield_ZZ_PUDown[5]->Fill(SRIndex,W_PUDown);
                    }
                    ///////////////////////////////////////////////
                    //Fill SR Hist Before Overflow Bin Adjustment//
                    ///////////////////////////////////////////////
                    ...
                    if (CatF) {
                        MCYield_ZZ_Pt1[5]->Fill(leadingPt_FL,W);
                        MCYield_ZZ_Pt2[5]->Fill(subleadingPt_FL,W);
                        MCYield_ZZ_Pt3[5]->Fill(trailingPt_FL,W);
                        MCYield_ZZ_Mll[5]->Fill(Mll_FL,W);
                        MCYield_ZZ_MT[5]->Fill(Mt2_FL,W);
                        MCYield_ZZ_MET[5]->Fill(_met_FL,W);
                        MCYield_ZZ_M3l[5]->Fill(M3l_FL,W);
                        MCYield_ZZ_SumQ[5]->Fill(SumQ,W);
                    }
                }
    ...
    //Hists for plots
    TH1F* Plot_MCYield_ZZ[nSRCat];
    TH1F* Plot_MCYield_ZZ_Pt1[nSRCat];
    TH1F* Plot_MCYield_ZZ_Pt2[nSRCat];
    TH1F* Plot_MCYield_ZZ_Pt3[nSRCat];
    TH1F* Plot_MCYield_ZZ_Mll[nSRCat];
    TH1F* Plot_MCYield_ZZ_MT[nSRCat];
    TH1F* Plot_MCYield_ZZ_MET[nSRCat];
    TH1F* Plot_MCYield_ZZ_M3l[nSRCat];
    TH1F* Plot_MCYield_ZZ_SumQ[nSRCat];
    
    TH1F* Plot_StatUnc_MCYield_ZZ[nSRCat];
    TH1F* Plot_StatUnc_MCYield_ZZ_Pt1[nSRCat];
    TH1F* Plot_StatUnc_MCYield_ZZ_Pt2[nSRCat];
    TH1F* Plot_StatUnc_MCYield_ZZ_Pt3[nSRCat];
    TH1F* Plot_StatUnc_MCYield_ZZ_Mll[nSRCat];
    TH1F* Plot_StatUnc_MCYield_ZZ_MT[nSRCat];
    TH1F* Plot_StatUnc_MCYield_ZZ_MET[nSRCat];
    TH1F* Plot_StatUnc_MCYield_ZZ_M3l[nSRCat];
    TH1F* Plot_StatUnc_MCYield_ZZ_SumQ[nSRCat];
    
    TH1F* Plot_TotUnc_MCYield_ZZ[nSRCat];
    TH1F* Plot_TotUnc_MCYield_ZZ_Pt1[nSRCat];
    TH1F* Plot_TotUnc_MCYield_ZZ_Pt2[nSRCat];
    TH1F* Plot_TotUnc_MCYield_ZZ_Pt3[nSRCat];
    TH1F* Plot_TotUnc_MCYield_ZZ_Mll[nSRCat];
    TH1F* Plot_TotUnc_MCYield_ZZ_MT[nSRCat];
    TH1F* Plot_TotUnc_MCYield_ZZ_MET[nSRCat];
    TH1F* Plot_TotUnc_MCYield_ZZ_M3l[nSRCat];
    TH1F* Plot_TotUnc_MCYield_ZZ_SumQ[nSRCat];
    //Hists for plots
    
    for (int i=0; i<nSRCat; i++) {
        
        Plot_MCYield_ZZ[i]=(TH1F*)MCYield_ZZ[i]->Clone();
        Plot_MCYield_ZZ_Pt1[i]=(TH1F*)MCYield_ZZ_Pt1[i]->Clone();
        Plot_MCYield_ZZ_Pt2[i]=(TH1F*)MCYield_ZZ_Pt2[i]->Clone();
        Plot_MCYield_ZZ_Pt3[i]=(TH1F*)MCYield_ZZ_Pt3[i]->Clone();
        Plot_MCYield_ZZ_Mll[i]=(TH1F*)MCYield_ZZ_Mll[i]->Clone();
        Plot_MCYield_ZZ_MT[i]=(TH1F*)MCYield_ZZ_MT[i]->Clone();
        Plot_MCYield_ZZ_MET[i]=(TH1F*)MCYield_ZZ_MET[i]->Clone();
        Plot_MCYield_ZZ_M3l[i]=(TH1F*)MCYield_ZZ_M3l[i]->Clone();
        Plot_MCYield_ZZ_SumQ[i]=(TH1F*)MCYield_ZZ_SumQ[i]->Clone();
        
        name="Plot_StatUnc_MCBG_ZZ_"+SRCat[i];
        Plot_StatUnc_MCYield_ZZ[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        Plot_StatUnc_MCYield_ZZ[i]->Sumw2();
        name="Plot_StatUnc_MCBG_ZZ_Pt1_"+SRCat[i];
        Plot_StatUnc_MCYield_ZZ_Pt1[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        Plot_StatUnc_MCYield_ZZ_Pt1[i]->Sumw2();
        name="Plot_StatUnc_MCBG_ZZ_Pt2_"+SRCat[i];
        Plot_StatUnc_MCYield_ZZ_Pt2[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        Plot_StatUnc_MCYield_ZZ_Pt2[i]->Sumw2();
        name="Plot_StatUnc_MCBG_ZZ_Pt3_"+SRCat[i];
        Plot_StatUnc_MCYield_ZZ_Pt3[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        Plot_StatUnc_MCYield_ZZ_Pt3[i]->Sumw2();
        name="Plot_StatUnc_MCBG_ZZ_Mll_"+SRCat[i];
        Plot_StatUnc_MCYield_ZZ_Mll[i]=new TH1F(name,"",Mllbin[i],Mlllowerbound,Mllupperbound[i]);
        Plot_StatUnc_MCYield_ZZ_Mll[i]->Sumw2();
        name="Plot_StatUnc_MCBG_ZZ_MT_"+SRCat[i];
        Plot_StatUnc_MCYield_ZZ_MT[i]=new TH1F(name,"",MTbin[i],MTlowerbound,MTupperbound[i]);
        Plot_StatUnc_MCYield_ZZ_MT[i]->Sumw2();
        name="Plot_StatUnc_MCBG_ZZ_MET_"+SRCat[i];
        Plot_StatUnc_MCYield_ZZ_MET[i]=new TH1F(name,"",METbin[i],METlowerbound,METupperbound[i]);
        Plot_StatUnc_MCYield_ZZ_MET[i]->Sumw2();
        name="Plot_StatUnc_MCBG_ZZ_M3l_"+SRCat[i];
        Plot_StatUnc_MCYield_ZZ_M3l[i]=new TH1F(name,"",M3lbin[i],M3llowerbound,M3lupperbound[i]);
        Plot_StatUnc_MCYield_ZZ_M3l[i]->Sumw2();
        name="Plot_StatUnc_MCBG_ZZ_SumQ_"+SRCat[i];
        Plot_StatUnc_MCYield_ZZ_SumQ[i]=new TH1F(name,"",SumQbin[i],SumQlowerbound,SumQupperbound[i]);
        Plot_StatUnc_MCYield_ZZ_SumQ[i]->Sumw2();
        
        name="Plot_TotUnc_MCBG_ZZ_"+SRCat[i];
        Plot_TotUnc_MCYield_ZZ[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        Plot_TotUnc_MCYield_ZZ[i]->Sumw2();
        name="Plot_TotUnc_MCBG_ZZ_Pt1_"+SRCat[i];
        Plot_TotUnc_MCYield_ZZ_Pt1[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        Plot_TotUnc_MCYield_ZZ_Pt1[i]->Sumw2();
        name="Plot_TotUnc_MCBG_ZZ_Pt2_"+SRCat[i];
        Plot_TotUnc_MCYield_ZZ_Pt2[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        Plot_TotUnc_MCYield_ZZ_Pt2[i]->Sumw2();
        name="Plot_TotUnc_MCBG_ZZ_Pt3_"+SRCat[i];
        Plot_TotUnc_MCYield_ZZ_Pt3[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        Plot_TotUnc_MCYield_ZZ_Pt3[i]->Sumw2();
        name="Plot_TotUnc_MCBG_ZZ_Mll_"+SRCat[i];
        Plot_TotUnc_MCYield_ZZ_Mll[i]=new TH1F(name,"",Mllbin[i],Mlllowerbound,Mllupperbound[i]);
        Plot_TotUnc_MCYield_ZZ_Mll[i]->Sumw2();
        name="Plot_TotUnc_MCBG_ZZ_MT_"+SRCat[i];
        Plot_TotUnc_MCYield_ZZ_MT[i]=new TH1F(name,"",MTbin[i],MTlowerbound,MTupperbound[i]);
        Plot_TotUnc_MCYield_ZZ_MT[i]->Sumw2();
        name="Plot_TotUnc_MCBG_ZZ_MET_"+SRCat[i];
        Plot_TotUnc_MCYield_ZZ_MET[i]=new TH1F(name,"",METbin[i],METlowerbound,METupperbound[i]);
        Plot_TotUnc_MCYield_ZZ_MET[i]->Sumw2();
        name="Plot_TotUnc_MCBG_ZZ_M3l_"+SRCat[i];
        Plot_TotUnc_MCYield_ZZ_M3l[i]=new TH1F(name,"",M3lbin[i],M3llowerbound,M3lupperbound[i]);
        Plot_TotUnc_MCYield_ZZ_M3l[i]->Sumw2();
        name="Plot_TotUnc_MCBG_ZZ_SumQ_"+SRCat[i];
        Plot_TotUnc_MCYield_ZZ_SumQ[i]=new TH1F(name,"",SumQbin[i],SumQlowerbound,SumQupperbound[i]);
        Plot_TotUnc_MCYield_ZZ_SumQ[i]->Sumw2();
    }
    ...
    for (int i=0; i<nSRCat; i++) {
         ...
         */
        //SR
        AssignUncForPlot_SRBG_NonWZ(Plot_MCYield_ZZ[i], uncertainty, nbinSR, MCYield_ZZ_JECUp[i], MCYield_ZZ_JECDown[i], MCYield_ZZ_BTagUp[i],MCYield_ZZ_BTagDown[i],MCYield_ZZ_LepSFUp[i],MCYield_ZZ_LepSFDown[i],MCYield_ZZ_PUUp[i],MCYield_ZZ_PUDown[i],Plot_StatUnc_MCYield_ZZ[i],Plot_TotUnc_MCYield_ZZ[i]);
        //Var
        AssignUncForPlot_VarBG_NonWZ(Plot_MCYield_ZZ_Pt1[i], uncertainty, nbinPt, Plot_StatUnc_MCYield_ZZ_Pt1[i],Plot_TotUnc_MCYield_ZZ_Pt1[i]);
        AssignUncForPlot_VarBG_NonWZ(Plot_MCYield_ZZ_Pt2[i], uncertainty, nbinPt, Plot_StatUnc_MCYield_ZZ_Pt2[i],Plot_TotUnc_MCYield_ZZ_Pt2[i]);
        AssignUncForPlot_VarBG_NonWZ(Plot_MCYield_ZZ_Pt3[i], uncertainty, nbinPt, Plot_StatUnc_MCYield_ZZ_Pt3[i],Plot_TotUnc_MCYield_ZZ_Pt3[i]);
        AssignUncForPlot_VarBG_NonWZ(Plot_MCYield_ZZ_Mll[i], uncertainty, nbinMll, Plot_StatUnc_MCYield_ZZ_Mll[i],Plot_TotUnc_MCYield_ZZ_Mll[i]);
        AssignUncForPlot_VarBG_NonWZ(Plot_MCYield_ZZ_MT[i], uncertainty, nbinMT, Plot_StatUnc_MCYield_ZZ_MT[i],Plot_TotUnc_MCYield_ZZ_MT[i]);
        AssignUncForPlot_VarBG_NonWZ(Plot_MCYield_ZZ_MET[i], uncertainty, nbinMET, Plot_StatUnc_MCYield_ZZ_MET[i],Plot_TotUnc_MCYield_ZZ_MET[i]);
        AssignUncForPlot_VarBG_NonWZ(Plot_MCYield_ZZ_M3l[i], uncertainty, nbinM3l, Plot_StatUnc_MCYield_ZZ_M3l[i],Plot_TotUnc_MCYield_ZZ_M3l[i]);
        AssignUncForPlot_VarBG_NonWZ(Plot_MCYield_ZZ_SumQ[i], uncertainty, nbinSumQ, Plot_StatUnc_MCYield_ZZ_SumQ[i],Plot_TotUnc_MCYield_ZZ_SumQ[i]);
    ...
    //Original Hists
    outputRootFile=new TFile("FinalYield_ZZ.root","CREATE");
    for (int i=0; i<nSRCat; i++) {
        MCYield_ZZ[i]->Write();
        MCYield_ZZ_JECUp[i]->Write();
        MCYield_ZZ_JECDown[i]->Write();
        MCYield_ZZ_BTagUp[i]->Write();
        MCYield_ZZ_BTagDown[i]->Write();
        MCYield_ZZ_LepSFUp[i]->Write();
        MCYield_ZZ_LepSFDown[i]->Write();
        MCYield_ZZ_PUUp[i]->Write();
        MCYield_ZZ_PUDown[i]->Write();
        
        MCYield_ZZ_Pt1[i]->Write();
        MCYield_ZZ_Pt2[i]->Write();
        MCYield_ZZ_Pt3[i]->Write();
        MCYield_ZZ_Mll[i]->Write();
        MCYield_ZZ_MT[i]->Write();
        MCYield_ZZ_MET[i]->Write();
        MCYield_ZZ_M3l[i]->Write();
        MCYield_ZZ_SumQ[i]->Write();
        
    }
    outputRootFile->Close();
    //For limit setting
    outputRootFile=new TFile("FinalYield_ZZ_Limit.root","CREATE");
    for (int i=0; i<nSRCat; i++) {
        MCYield_ZZ[i]->Write();
        MCYield_ZZ_JECUp[i]->Write();
        MCYield_ZZ_JECDown[i]->Write();
    ...
    outputRootFile->Close();
    //For plots
    outputRootFile=new TFile("FinalYield_ZZ_Plot.root","CREATE");
    for (int i=0; i<nSRCat; i++) {
        Plot_MCYield_ZZ[i]->Write();
        Plot_MCYield_ZZ_Pt1[i]->Write();
        Plot_MCYield_ZZ_Pt2[i]->Write();
        Plot_MCYield_ZZ_Pt3[i]->Write();
        Plot_MCYield_ZZ_Mll[i]->Write();
        Plot_MCYield_ZZ_MT[i]->Write();
        Plot_MCYield_ZZ_MET[i]->Write();
        Plot_MCYield_ZZ_M3l[i]->Write();
        Plot_MCYield_ZZ_SumQ[i]->Write();
        
        Plot_StatUnc_MCYield_ZZ[i]->Write();
        Plot_StatUnc_MCYield_ZZ_Pt1[i]->Write();
        Plot_StatUnc_MCYield_ZZ_Pt2[i]->Write();
        Plot_StatUnc_MCYield_ZZ_Pt3[i]->Write();
        Plot_StatUnc_MCYield_ZZ_Mll[i]->Write();
        Plot_StatUnc_MCYield_ZZ_MT[i]->Write();
        Plot_StatUnc_MCYield_ZZ_MET[i]->Write();
        Plot_StatUnc_MCYield_ZZ_M3l[i]->Write();
        Plot_StatUnc_MCYield_ZZ_SumQ[i]->Write();
        
        Plot_TotUnc_MCYield_ZZ[i]->Write();
        Plot_TotUnc_MCYield_ZZ_Pt1[i]->Write();
        Plot_TotUnc_MCYield_ZZ_Pt2[i]->Write();
        Plot_TotUnc_MCYield_ZZ_Pt3[i]->Write();
        Plot_TotUnc_MCYield_ZZ_Mll[i]->Write();
        Plot_TotUnc_MCYield_ZZ_MT[i]->Write();
        Plot_TotUnc_MCYield_ZZ_MET[i]->Write();
        Plot_TotUnc_MCYield_ZZ_M3l[i]->Write();
        Plot_TotUnc_MCYield_ZZ_SumQ[i]->Write();
    }
    outputRootFile->Close();
