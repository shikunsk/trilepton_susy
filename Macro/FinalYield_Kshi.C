...
void FinalYield::Loop()
{
    ...
    for (int iSam=0; iSam<nbMCsamples; iSam++) {
        ...
        MCVtx[iSam]=new TFile("/ufrc/acosta/kshi/SUSY/CMSSW_8_0_13/src/output/"+samplefilesMC[iSam],"open");
    ...
    TFile* SFmap;
    //Electron
    SFmap=new TFile("/ufrc/acosta/kshi/SUSY/CMSSW_8_0_13/src/Macro/ScaleFactor/el_SF_FullSim.root","open");
    TH2D* el_SF_FullSim = (TH2D*)SFmap->Get("GsfElectronToLeptonMvaMIDEmuTightIP2DSIP3D8mini04");
    SFmap=new TFile("/ufrc/acosta/kshi/SUSY/CMSSW_8_0_13/src/Macro/ScaleFactor/el_RecoSF_FullSim.root","open");
    TH2D* el_RecoSF_FullSim = (TH2D*)SFmap->Get("EGamma_SF2D");
    //Muon
    SFmap=new TFile("/ufrc/acosta/kshi/SUSY/CMSSW_8_0_13/src/Macro/ScaleFactor/mu_dxydz_SF_FullSim.root","open");
    TH2D* mu_dxydz_SF_FullSim = (TH2D*)SFmap->Get("SF");
    SFmap=new TFile("/ufrc/acosta/kshi/SUSY/CMSSW_8_0_13/src/Macro/ScaleFactor/mu_MediumID_SF_FullSim.root","open");
    TH2D* mu_MediumID_SF_FullSim = (TH2D*)SFmap->Get("SF");
    SFmap=new TFile("/ufrc/acosta/kshi/SUSY/CMSSW_8_0_13/src/Macro/ScaleFactor/mu_miniIso_SF_FullSim.root","open");
    TH2D* mu_miniIso_SF_FullSim = (TH2D*)SFmap->Get("SF");
    SFmap=new TFile("/ufrc/acosta/kshi/SUSY/CMSSW_8_0_13/src/Macro/ScaleFactor/mu_LepMVAVM_SF_FullSim.root","open");
    TH2D* mu_LepMVAVM_SF_FullSim = (TH2D*)SFmap->Get("SF");
    SFmap=new TFile("/ufrc/acosta/kshi/SUSY/CMSSW_8_0_13/src/Macro/ScaleFactor/mu_RecoSF_FullSim.root","open");
    ...
    TH1F* MCYield_WZ[nSRCat];
    TH1F* MCYield_WZ_JECUp[nSRCat];
    TH1F* MCYield_WZ_JECDown[nSRCat];
    TH1F* MCYield_WZ_BTagUp[nSRCat];
    TH1F* MCYield_WZ_BTagDown[nSRCat];
    TH1F* MCYield_WZ_LepSFUp[nSRCat];
    TH1F* MCYield_WZ_LepSFDown[nSRCat];
    TH1F* MCYield_WZ_PUUp[nSRCat];
    TH1F* MCYield_WZ_PUDown[nSRCat];
    
    TH1F* MCYield_WZ_Pt1[nSRCat];
    TH1F* MCYield_WZ_Pt2[nSRCat];
    TH1F* MCYield_WZ_Pt3[nSRCat];
    TH1F* MCYield_WZ_Mll[nSRCat];
    TH1F* MCYield_WZ_MT[nSRCat];
    TH1F* MCYield_WZ_MET[nSRCat];
    TH1F* MCYield_WZ_M3l[nSRCat];
    TH1F* MCYield_WZ_SumQ[nSRCat];
    
    for (int i=0; i<nSRCat; i++) {
        name="MCBG_WZ_"+SRCat[i];
        MCYield_WZ[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_WZ[i]->Sumw2();
        name="MCBG_WZ_JECUp_"+SRCat[i];
        MCYield_WZ_JECUp[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_WZ_JECUp[i]->Sumw2();
        name="MCBG_WZ_JECDown_"+SRCat[i];
        MCYield_WZ_JECDown[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_WZ_JECDown[i]->Sumw2();
        name="MCBG_WZ_BTagUp_"+SRCat[i];
        MCYield_WZ_BTagUp[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_WZ_BTagUp[i]->Sumw2();
        name="MCBG_WZ_BTagDown_"+SRCat[i];
        MCYield_WZ_BTagDown[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_WZ_BTagDown[i]->Sumw2();
        name="MCBG_WZ_LepSFUp_"+SRCat[i];
        MCYield_WZ_LepSFUp[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_WZ_LepSFUp[i]->Sumw2();
        name="MCBG_WZ_LepSFDown_"+SRCat[i];
        MCYield_WZ_LepSFDown[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_WZ_LepSFDown[i]->Sumw2();
        name="MCBG_WZ_PUUp_"+SRCat[i];
        MCYield_WZ_PUUp[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_WZ_PUUp[i]->Sumw2();
        name="MCBG_WZ_PUDown_"+SRCat[i];
        MCYield_WZ_PUDown[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        MCYield_WZ_PUDown[i]->Sumw2();
        
        name="MCBG_WZ_Pt1_"+SRCat[i];
        MCYield_WZ_Pt1[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        MCYield_WZ_Pt1[i]->Sumw2();
        name="MCBG_WZ_Pt2_"+SRCat[i];
        MCYield_WZ_Pt2[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        MCYield_WZ_Pt2[i]->Sumw2();
        name="MCBG_WZ_Pt3_"+SRCat[i];
        MCYield_WZ_Pt3[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        MCYield_WZ_Pt3[i]->Sumw2();
        name="MCBG_WZ_Mll_"+SRCat[i];
        MCYield_WZ_Mll[i]=new TH1F(name,"",Mllbin[i],Mlllowerbound,Mllupperbound[i]);
        MCYield_WZ_Mll[i]->Sumw2();
        name="MCBG_WZ_MT_"+SRCat[i];
        MCYield_WZ_MT[i]=new TH1F(name,"",MTbin[i],MTlowerbound,MTupperbound[i]);
        MCYield_WZ_MT[i]->Sumw2();
        name="MCBG_WZ_MET_"+SRCat[i];
        MCYield_WZ_MET[i]=new TH1F(name,"",METbin[i],METlowerbound,METupperbound[i]);
        MCYield_WZ_MET[i]->Sumw2();
        name="MCBG_WZ_M3l_"+SRCat[i];
        MCYield_WZ_M3l[i]=new TH1F(name,"",M3lbin[i],M3llowerbound,M3lupperbound[i]);
        MCYield_WZ_M3l[i]->Sumw2();
        name="MCBG_WZ_SumQ_"+SRCat[i];
        MCYield_WZ_SumQ[i]=new TH1F(name,"",SumQbin[i],SumQlowerbound,SumQupperbound[i]);
        MCYield_WZ_SumQ[i]->Sumw2();
    }
    ...
    for(int iSam = 0;  iSam <nbMCsamples; iSam++){//loop over all MC samples
        ...
        inputMC[iSam] = new TFile("/ufrc/acosta/kshi/SUSY/CMSSW_8_0_13/src/output/"+samplefilesMC[iSam],"open");
            ...
            if (nTau==0) {
                ...
                if (!bJetandMETflag_JECUp) {
                    if (CatA) {
                        ...
                        MCYield_WZ_JECUp[0]->Fill(SRIndex,W);
                    }
                    if (CatB) {
                        SRIndex=CalcSRIndex_B(_met_JECup,Mll,Mt_JECUp);
                        MCYield_WZ_JECUp[1]->Fill(SRIndex,W);
                    }
                }
                //JECDown
                if (!bJetandMETflag_JECDown) {
                    if (CatA) {
                        ...
                        MCYield_WZ_JECDown[0]->Fill(SRIndex,W);
                    }
                    if (CatB) {
                        SRIndex=CalcSRIndex_B(_met_JECdown,Mll,Mt_JECDown);
                        MCYield_WZ_JECDown[1]->Fill(SRIndex,W);
                    }
                }
                //NO JEC
                if (!bJetandMETflag) {
                    ...
                    if (CatA) {
                        ...
                        MCYield_WZ[0]->Fill(SRIndex,W);
                        MCYield_WZ_BTagUp[0]->Fill(SRIndex,W_BTagUp);
                        MCYield_WZ_BTagDown[0]->Fill(SRIndex,W_BTagDown);
                        MCYield_WZ_LepSFUp[0]->Fill(SRIndex,W_LepSFUp);
                        MCYield_WZ_LepSFDown[0]->Fill(SRIndex,W_LepSFDown);
                        MCYield_WZ_PUUp[0]->Fill(SRIndex,W_PUUp);
                        MCYield_WZ_PUDown[0]->Fill(SRIndex,W_PUDown);
                    }
                    if (CatB) {
                        SRIndex=CalcSRIndex_B(_met,Mll,Mt);
                        MCYield_WZ[1]->Fill(SRIndex,W);
                        MCYield_WZ_BTagUp[1]->Fill(SRIndex,W_BTagUp);
                        MCYield_WZ_BTagDown[1]->Fill(SRIndex,W_BTagDown);
                        MCYield_WZ_LepSFUp[1]->Fill(SRIndex,W_LepSFUp);
                        MCYield_WZ_LepSFDown[1]->Fill(SRIndex,W_LepSFDown);
                        MCYield_WZ_PUUp[1]->Fill(SRIndex,W_PUUp);
                        MCYield_WZ_PUDown[1]->Fill(SRIndex,W_PUDown);
                    }
                    ///////////////////////////////////////////////
                    //Fill SR Hist Before Overflow Bin Adjustment//
                    ///////////////////////////////////////////////
                    ...
                    //////FILL HIST////////
                    if (CatA) {
                        MCYield_WZ_Pt1[0]->Fill(leadingPt_FL,W);
                        MCYield_WZ_Pt2[0]->Fill(subleadingPt_FL,W);
                        MCYield_WZ_Pt3[0]->Fill(trailingPt_FL,W);
                        MCYield_WZ_Mll[0]->Fill(Mll_FL,W);
                        MCYield_WZ_MT[0]->Fill(Mt_FL,W);
                        MCYield_WZ_MET[0]->Fill(_met_FL,W);
                        MCYield_WZ_M3l[0]->Fill(M3l_FL,W);
                        MCYield_WZ_SumQ[0]->Fill(SumQ,W);
                    }
                    if (CatB) {
                        MCYield_WZ_Pt1[1]->Fill(leadingPt_FL,W);
                        MCYield_WZ_Pt2[1]->Fill(subleadingPt_FL,W);
                        MCYield_WZ_Pt3[1]->Fill(trailingPt_FL,W);
                        MCYield_WZ_Mll[1]->Fill(Mll_FL,W);
                        MCYield_WZ_MT[1]->Fill(Mt_FL,W);
                        MCYield_WZ_MET[1]->Fill(_met_FL,W);
                        MCYield_WZ_M3l[1]->Fill(M3l_FL,W);
                        MCYield_WZ_SumQ[1]->Fill(SumQ,W);
                    }
            ...
            if (nTau==1) {
                ...
                if (!bJetandMETflag_JECUp) {
                    if (CatC) {
                        ...
                        MCYield_WZ_JECUp[2]->Fill(SRIndex,W);
                    }
                    if (CatD) {
                        SRIndex=CalcSRIndex_D(_met_JECup,Mll,Mt2_JECUp);
                        MCYield_WZ_JECUp[3]->Fill(SRIndex,W);
                    }
                    if (CatE) {
                        SRIndex=CalcSRIndex_E(_met_JECup,Mll,Mt2_JECUp);
                        MCYield_WZ_JECUp[4]->Fill(SRIndex,W);
                    }
                }
                //JECDown
                if (!bJetandMETflag_JECDown) {
                    if (CatC) {
                        ...
                        MCYield_WZ_JECDown[2]->Fill(SRIndex,W);
                    }
                    if (CatD) {
                        SRIndex=CalcSRIndex_D(_met_JECdown,Mll,Mt2_JECDown);
                        MCYield_WZ_JECDown[3]->Fill(SRIndex,W);
                    }
                    if (CatE) {
                        SRIndex=CalcSRIndex_E(_met_JECdown,Mll,Mt2_JECDown);
                        MCYield_WZ_JECDown[4]->Fill(SRIndex,W);
                    }
                }
                //NO JEC
                if (!bJetandMETflag) {
                    ...
                    if (CatC) {
                        ...
                        MCYield_WZ[2]->Fill(SRIndex,W);
                        MCYield_WZ_BTagUp[2]->Fill(SRIndex,W_BTagUp);
                        MCYield_WZ_BTagDown[2]->Fill(SRIndex,W_BTagDown);
                        MCYield_WZ_LepSFUp[2]->Fill(SRIndex,W_LepSFUp);
                        MCYield_WZ_LepSFDown[2]->Fill(SRIndex,W_LepSFDown);
                        MCYield_WZ_PUUp[2]->Fill(SRIndex,W_PUUp);
                        MCYield_WZ_PUDown[2]->Fill(SRIndex,W_PUDown);
                    }
                    if (CatD) {
                        SRIndex=CalcSRIndex_D(_met,Mll,Mt2);
                        MCYield_WZ[3]->Fill(SRIndex,W);
                        MCYield_WZ_BTagUp[3]->Fill(SRIndex,W_BTagUp);
                        MCYield_WZ_BTagDown[3]->Fill(SRIndex,W_BTagDown);
                        MCYield_WZ_LepSFUp[3]->Fill(SRIndex,W_LepSFUp);
                        MCYield_WZ_LepSFDown[3]->Fill(SRIndex,W_LepSFDown);
                        MCYield_WZ_PUUp[3]->Fill(SRIndex,W_PUUp);
                        MCYield_WZ_PUDown[3]->Fill(SRIndex,W_PUDown);
                    }
                    if (CatE) {
                        SRIndex=CalcSRIndex_E(_met,Mll,Mt2);
                        MCYield_WZ[4]->Fill(SRIndex,W);
                        MCYield_WZ_BTagUp[4]->Fill(SRIndex,W_BTagUp);
                        MCYield_WZ_BTagDown[4]->Fill(SRIndex,W_BTagDown);
                        MCYield_WZ_LepSFUp[4]->Fill(SRIndex,W_LepSFUp);
                        MCYield_WZ_LepSFDown[4]->Fill(SRIndex,W_LepSFDown);
                        MCYield_WZ_PUUp[4]->Fill(SRIndex,W_PUUp);
                        MCYield_WZ_PUDown[4]->Fill(SRIndex,W_PUDown);
                    }
                    ///////////////////////////////////////////////
                    //Fill SR Hist Before Overflow Bin Adjustment//
                    ///////////////////////////////////////////////
                    ...
                    if (CatC) {
                        MCYield_WZ_Pt1[2]->Fill(leadingPt_FL,W);
                        MCYield_WZ_Pt2[2]->Fill(subleadingPt_FL,W);
                        MCYield_WZ_Pt3[2]->Fill(trailingPt_FL,W);
                        MCYield_WZ_Mll[2]->Fill(Mll_FL,W);
                        MCYield_WZ_MT[2]->Fill(Mt2_FL,W);
                        MCYield_WZ_MET[2]->Fill(_met_FL,W);
                        MCYield_WZ_M3l[2]->Fill(M3l_FL,W);
                        MCYield_WZ_SumQ[2]->Fill(SumQ,W);
                    }
                    if (CatD) {
                        MCYield_WZ_Pt1[3]->Fill(leadingPt_FL,W);
                        MCYield_WZ_Pt2[3]->Fill(subleadingPt_FL,W);
                        MCYield_WZ_Pt3[3]->Fill(trailingPt_FL,W);
                        MCYield_WZ_Mll[3]->Fill(Mll_FL,W);
                        MCYield_WZ_MT[3]->Fill(Mt2_FL,W);
                        MCYield_WZ_MET[3]->Fill(_met_FL,W);
                        MCYield_WZ_M3l[3]->Fill(M3l_FL,W);
                        MCYield_WZ_SumQ[3]->Fill(SumQ,W);
                    }
                    if (CatE) {
                        MCYield_WZ_Pt1[4]->Fill(leadingPt_FL,W);
                        MCYield_WZ_Pt2[4]->Fill(subleadingPt_FL,W);
                        MCYield_WZ_Pt3[4]->Fill(trailingPt_FL,W);
                        MCYield_WZ_Mll[4]->Fill(Mll_FL,W);
                        MCYield_WZ_MT[4]->Fill(Mt2_FL,W);
                        MCYield_WZ_MET[4]->Fill(_met_FL,W);
                        MCYield_WZ_M3l[4]->Fill(M3l_FL,W);
                        MCYield_WZ_SumQ[4]->Fill(SumQ,W);
                    }
                }//NO JEC
            ...
            if (nTau==2) {
                ...
                if (!bJetandMETflag_JECUp) {
                    if (CatF) {
                        ...
                        MCYield_WZ_JECUp[5]->Fill(SRIndex,W);
                    }
                }
                //JECDown
                if (!bJetandMETflag_JECDown) {
                    if (CatF) {
                        ...
                        MCYield_WZ_JECDown[5]->Fill(SRIndex,W);
                    }
                }
                //NO JEC
                if (!bJetandMETflag) {
                    ...
                    if (CatF) {
                        ...
                        MCYield_WZ[5]->Fill(SRIndex,W);
                        MCYield_WZ_BTagUp[5]->Fill(SRIndex,W_BTagUp);
                        MCYield_WZ_BTagDown[5]->Fill(SRIndex,W_BTagDown);
                        MCYield_WZ_LepSFUp[5]->Fill(SRIndex,W_LepSFUp);
                        MCYield_WZ_LepSFDown[5]->Fill(SRIndex,W_LepSFDown);
                        MCYield_WZ_PUUp[5]->Fill(SRIndex,W_PUUp);
                        MCYield_WZ_PUDown[5]->Fill(SRIndex,W_PUDown);
                    }
                    ///////////////////////////////////////////////
                    //Fill SR Hist Before Overflow Bin Adjustment//
                    ///////////////////////////////////////////////
                    ...
                    if (CatF) {
                        MCYield_WZ_Pt1[5]->Fill(leadingPt_FL,W);
                        MCYield_WZ_Pt2[5]->Fill(subleadingPt_FL,W);
                        MCYield_WZ_Pt3[5]->Fill(trailingPt_FL,W);
                        MCYield_WZ_Mll[5]->Fill(Mll_FL,W);
                        MCYield_WZ_MT[5]->Fill(Mt2_FL,W);
                        MCYield_WZ_MET[5]->Fill(_met_FL,W);
                        MCYield_WZ_M3l[5]->Fill(M3l_FL,W);
                        MCYield_WZ_SumQ[5]->Fill(SumQ,W);
                    }
                }//NO JEC
    ...
    TH1F* MCYield_WZ_WZShapeUp[nSRCat]; //Shape WZ + 1 sigma
    TH1F* MCYield_WZ_WZShapeDown[nSRCat]; //Shape WZ + 1 sigma
    //Hists for limit setting
    
    //Hists for plots
    TH1F* Plot_MCYield_WZ[nSRCat];
    TH1F* Plot_MCYield_WZ_Pt1[nSRCat];
    TH1F* Plot_MCYield_WZ_Pt2[nSRCat];
    TH1F* Plot_MCYield_WZ_Pt3[nSRCat];
    TH1F* Plot_MCYield_WZ_Mll[nSRCat];
    TH1F* Plot_MCYield_WZ_MT[nSRCat];
    TH1F* Plot_MCYield_WZ_MET[nSRCat];
    TH1F* Plot_MCYield_WZ_M3l[nSRCat];
    TH1F* Plot_MCYield_WZ_SumQ[nSRCat];
    
    TH1F* Plot_StatUnc_MCYield_WZ[nSRCat];
    TH1F* Plot_StatUnc_MCYield_WZ_Pt1[nSRCat];
    TH1F* Plot_StatUnc_MCYield_WZ_Pt2[nSRCat];
    TH1F* Plot_StatUnc_MCYield_WZ_Pt3[nSRCat];
    TH1F* Plot_StatUnc_MCYield_WZ_Mll[nSRCat];
    TH1F* Plot_StatUnc_MCYield_WZ_MT[nSRCat];
    TH1F* Plot_StatUnc_MCYield_WZ_MET[nSRCat];
    TH1F* Plot_StatUnc_MCYield_WZ_M3l[nSRCat];
    TH1F* Plot_StatUnc_MCYield_WZ_SumQ[nSRCat];
    
    TH1F* Plot_TotUnc_MCYield_WZ[nSRCat];
    TH1F* Plot_TotUnc_MCYield_WZ_Pt1[nSRCat];
    TH1F* Plot_TotUnc_MCYield_WZ_Pt2[nSRCat];
    TH1F* Plot_TotUnc_MCYield_WZ_Pt3[nSRCat];
    TH1F* Plot_TotUnc_MCYield_WZ_Mll[nSRCat];
    TH1F* Plot_TotUnc_MCYield_WZ_MT[nSRCat];
    TH1F* Plot_TotUnc_MCYield_WZ_MET[nSRCat];
    TH1F* Plot_TotUnc_MCYield_WZ_M3l[nSRCat];
    TH1F* Plot_TotUnc_MCYield_WZ_SumQ[nSRCat];
    //Hists for plots
    
    for (int i=0; i<nSRCat; i++) {
        
        name="MCBG_WZ_WZShapeUp_"+SRCat[i];
        MCYield_WZ_WZShapeUp[i]=(TH1F*)MCYield_WZ[i]->Clone(name);
        name="MCBG_WZ_WZShapeDown_"+SRCat[i];
        MCYield_WZ_WZShapeDown[i]=(TH1F*)MCYield_WZ[i]->Clone(name);
        
        Plot_MCYield_WZ[i]=(TH1F*)MCYield_WZ[i]->Clone();
        Plot_MCYield_WZ_Pt1[i]=(TH1F*)MCYield_WZ_Pt1[i]->Clone();
        Plot_MCYield_WZ_Pt2[i]=(TH1F*)MCYield_WZ_Pt2[i]->Clone();
        Plot_MCYield_WZ_Pt3[i]=(TH1F*)MCYield_WZ_Pt3[i]->Clone();
        Plot_MCYield_WZ_Mll[i]=(TH1F*)MCYield_WZ_Mll[i]->Clone();
        Plot_MCYield_WZ_MT[i]=(TH1F*)MCYield_WZ_MT[i]->Clone();
        Plot_MCYield_WZ_MET[i]=(TH1F*)MCYield_WZ_MET[i]->Clone();
        Plot_MCYield_WZ_M3l[i]=(TH1F*)MCYield_WZ_M3l[i]->Clone();
        Plot_MCYield_WZ_SumQ[i]=(TH1F*)MCYield_WZ_SumQ[i]->Clone();
        
        name="Plot_StatUnc_MCBG_WZ_"+SRCat[i];
        Plot_StatUnc_MCYield_WZ[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        Plot_StatUnc_MCYield_WZ[i]->Sumw2();
        name="Plot_StatUnc_MCBG_WZ_Pt1_"+SRCat[i];
        Plot_StatUnc_MCYield_WZ_Pt1[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        Plot_StatUnc_MCYield_WZ_Pt1[i]->Sumw2();
        name="Plot_StatUnc_MCBG_WZ_Pt2_"+SRCat[i];
        Plot_StatUnc_MCYield_WZ_Pt2[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        Plot_StatUnc_MCYield_WZ_Pt2[i]->Sumw2();
        name="Plot_StatUnc_MCBG_WZ_Pt3_"+SRCat[i];
        Plot_StatUnc_MCYield_WZ_Pt3[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        Plot_StatUnc_MCYield_WZ_Pt3[i]->Sumw2();
        name="Plot_StatUnc_MCBG_WZ_Mll_"+SRCat[i];
        Plot_StatUnc_MCYield_WZ_Mll[i]=new TH1F(name,"",Mllbin[i],Mlllowerbound,Mllupperbound[i]);
        Plot_StatUnc_MCYield_WZ_Mll[i]->Sumw2();
        name="Plot_StatUnc_MCBG_WZ_MT_"+SRCat[i];
        Plot_StatUnc_MCYield_WZ_MT[i]=new TH1F(name,"",MTbin[i],MTlowerbound,MTupperbound[i]);
        Plot_StatUnc_MCYield_WZ_MT[i]->Sumw2();
        name="Plot_StatUnc_MCBG_WZ_MET_"+SRCat[i];
        Plot_StatUnc_MCYield_WZ_MET[i]=new TH1F(name,"",METbin[i],METlowerbound,METupperbound[i]);
        Plot_StatUnc_MCYield_WZ_MET[i]->Sumw2();
        name="Plot_StatUnc_MCBG_WZ_M3l_"+SRCat[i];
        Plot_StatUnc_MCYield_WZ_M3l[i]=new TH1F(name,"",M3lbin[i],M3llowerbound,M3lupperbound[i]);
        Plot_StatUnc_MCYield_WZ_M3l[i]->Sumw2();
        name="Plot_StatUnc_MCBG_WZ_SumQ_"+SRCat[i];
        Plot_StatUnc_MCYield_WZ_SumQ[i]=new TH1F(name,"",SumQbin[i],SumQlowerbound,SumQupperbound[i]);
        Plot_StatUnc_MCYield_WZ_SumQ[i]->Sumw2();
        
        name="Plot_TotUnc_MCBG_WZ_"+SRCat[i];
        Plot_TotUnc_MCYield_WZ[i]=new TH1F(name,"",nSR[i],0.5,nSR[i]+0.5);
        Plot_TotUnc_MCYield_WZ[i]->Sumw2();
        name="Plot_TotUnc_MCBG_WZ_Pt1_"+SRCat[i];
        Plot_TotUnc_MCYield_WZ_Pt1[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        Plot_TotUnc_MCYield_WZ_Pt1[i]->Sumw2();
        name="Plot_TotUnc_MCBG_WZ_Pt2_"+SRCat[i];
        Plot_TotUnc_MCYield_WZ_Pt2[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        Plot_TotUnc_MCYield_WZ_Pt2[i]->Sumw2();
        name="Plot_TotUnc_MCBG_WZ_Pt3_"+SRCat[i];
        Plot_TotUnc_MCYield_WZ_Pt3[i]=new TH1F(name,"",Ptbin[i],Ptlowerbound,Ptupperbound[i]);
        Plot_TotUnc_MCYield_WZ_Pt3[i]->Sumw2();
        name="Plot_TotUnc_MCBG_WZ_Mll_"+SRCat[i];
        Plot_TotUnc_MCYield_WZ_Mll[i]=new TH1F(name,"",Mllbin[i],Mlllowerbound,Mllupperbound[i]);
        Plot_TotUnc_MCYield_WZ_Mll[i]->Sumw2();
        name="Plot_TotUnc_MCBG_WZ_MT_"+SRCat[i];
        Plot_TotUnc_MCYield_WZ_MT[i]=new TH1F(name,"",MTbin[i],MTlowerbound,MTupperbound[i]);
        Plot_TotUnc_MCYield_WZ_MT[i]->Sumw2();
        name="Plot_TotUnc_MCBG_WZ_MET_"+SRCat[i];
        Plot_TotUnc_MCYield_WZ_MET[i]=new TH1F(name,"",METbin[i],METlowerbound,METupperbound[i]);
        Plot_TotUnc_MCYield_WZ_MET[i]->Sumw2();
        name="Plot_TotUnc_MCBG_WZ_M3l_"+SRCat[i];
        Plot_TotUnc_MCYield_WZ_M3l[i]=new TH1F(name,"",M3lbin[i],M3llowerbound,M3lupperbound[i]);
        Plot_TotUnc_MCYield_WZ_M3l[i]->Sumw2();
        name="Plot_TotUnc_MCBG_WZ_SumQ_"+SRCat[i];
        Plot_TotUnc_MCYield_WZ_SumQ[i]=new TH1F(name,"",SumQbin[i],SumQlowerbound,SumQupperbound[i]);
        Plot_TotUnc_MCYield_WZ_SumQ[i]->Sumw2();
    }
    ...
    for (int i=0; i<nSRCat; i++) {
        ...
        //Hists for limit setting
        /*
         *Shape for WZ +- 1 sigma
         */
        ShapeForLimitSetting_WZ(MCYield_WZ_WZShapeUp[i], nbinSR, 1);
        ShapeForLimitSetting_WZ(MCYield_WZ_WZShapeDown[i], nbinSR, -1);
         ...
         */
        //SR
        AssignUncForPlot_SRBG_WZ(Plot_MCYield_WZ[i], nbinSR, MCYield_WZ_JECUp[i], MCYield_WZ_JECDown[i], MCYield_WZ_BTagUp[i],MCYield_WZ_BTagDown[i],MCYield_WZ_LepSFUp[i],MCYield_WZ_LepSFDown[i],MCYield_WZ_PUUp[i],MCYield_WZ_PUDown[i],Plot_StatUnc_MCYield_WZ[i],Plot_TotUnc_MCYield_WZ[i]);
        //Var
        AssignUncForPlot_VarBG_WZ(Plot_MCYield_WZ_Pt1[i], uncertainty, nbinPt, Plot_StatUnc_MCYield_WZ_Pt1[i],Plot_TotUnc_MCYield_WZ_Pt1[i]);
        AssignUncForPlot_VarBG_WZ(Plot_MCYield_WZ_Pt2[i], uncertainty, nbinPt, Plot_StatUnc_MCYield_WZ_Pt2[i],Plot_TotUnc_MCYield_WZ_Pt2[i]);
        AssignUncForPlot_VarBG_WZ(Plot_MCYield_WZ_Pt3[i], uncertainty, nbinPt, Plot_StatUnc_MCYield_WZ_Pt3[i],Plot_TotUnc_MCYield_WZ_Pt3[i]);
        AssignUncForPlot_VarBG_WZ(Plot_MCYield_WZ_Mll[i], uncertainty, nbinMll, Plot_StatUnc_MCYield_WZ_Mll[i],Plot_TotUnc_MCYield_WZ_Mll[i]);
        AssignUncForPlot_VarBG_WZ(Plot_MCYield_WZ_MT[i], uncertainty, nbinMT, Plot_StatUnc_MCYield_WZ_MT[i],Plot_TotUnc_MCYield_WZ_MT[i]);
        AssignUncForPlot_VarBG_WZ(Plot_MCYield_WZ_MET[i], uncertainty, nbinMET, Plot_StatUnc_MCYield_WZ_MET[i],Plot_TotUnc_MCYield_WZ_MET[i]);
        AssignUncForPlot_VarBG_WZ(Plot_MCYield_WZ_M3l[i], uncertainty, nbinM3l, Plot_StatUnc_MCYield_WZ_M3l[i],Plot_TotUnc_MCYield_WZ_M3l[i]);
        AssignUncForPlot_VarBG_WZ(Plot_MCYield_WZ_SumQ[i], uncertainty, nbinSumQ, Plot_StatUnc_MCYield_WZ_SumQ[i],Plot_TotUnc_MCYield_WZ_SumQ[i]);
    ...
    //Original Hists
    outputRootFile=new TFile("FinalYield_Kshi.root","CREATE");
    for (int i=0; i<nSRCat; i++) {
        MCYield_WZ[i]->Write();
        MCYield_WZ_JECUp[i]->Write();
        MCYield_WZ_JECDown[i]->Write();
        MCYield_WZ_BTagUp[i]->Write();
        MCYield_WZ_BTagDown[i]->Write();
        MCYield_WZ_LepSFUp[i]->Write();
        MCYield_WZ_LepSFDown[i]->Write();
        MCYield_WZ_PUUp[i]->Write();
        MCYield_WZ_PUDown[i]->Write();
        
        MCYield_WZ_Pt1[i]->Write();
        MCYield_WZ_Pt2[i]->Write();
        MCYield_WZ_Pt3[i]->Write();
        MCYield_WZ_Mll[i]->Write();
        MCYield_WZ_MT[i]->Write();
        MCYield_WZ_MET[i]->Write();
        MCYield_WZ_M3l[i]->Write();
        MCYield_WZ_SumQ[i]->Write();
        
    }
    outputRootFile->Close();
    //For limit setting
    outputRootFile=new TFile("FinalYield_WZ_Limit.root","CREATE");
    for (int i=0; i<nSRCat; i++) {
        MCYield_WZ[i]->Write();
        MCYield_WZ_WZShapeUp[i]->Write();
        MCYield_WZ_WZShapeDown[i]->Write();
        MCYield_WZ_JECUp[i]->Write();
        MCYield_WZ_JECDown[i]->Write();
        MCYield_WZ_BTagUp[i]->Write();
        MCYield_WZ_BTagDown[i]->Write();
    ...
    outputRootFile->Close();
    //For plots
    outputRootFile=new TFile("FinalYield_WZ_Plot.root","CREATE");
    for (int i=0; i<nSRCat; i++) {
        Plot_MCYield_WZ[i]->Write();
        Plot_MCYield_WZ_Pt1[i]->Write();
        Plot_MCYield_WZ_Pt2[i]->Write();
        Plot_MCYield_WZ_Pt3[i]->Write();
        Plot_MCYield_WZ_Mll[i]->Write();
        Plot_MCYield_WZ_MT[i]->Write();
        Plot_MCYield_WZ_MET[i]->Write();
        Plot_MCYield_WZ_M3l[i]->Write();
        Plot_MCYield_WZ_SumQ[i]->Write();
        
        Plot_StatUnc_MCYield_WZ[i]->Write();
        Plot_StatUnc_MCYield_WZ_Pt1[i]->Write();
        Plot_StatUnc_MCYield_WZ_Pt2[i]->Write();
        Plot_StatUnc_MCYield_WZ_Pt3[i]->Write();
        Plot_StatUnc_MCYield_WZ_Mll[i]->Write();
        Plot_StatUnc_MCYield_WZ_MT[i]->Write();
        Plot_StatUnc_MCYield_WZ_MET[i]->Write();
        Plot_StatUnc_MCYield_WZ_M3l[i]->Write();
        Plot_StatUnc_MCYield_WZ_SumQ[i]->Write();
        
        Plot_TotUnc_MCYield_WZ[i]->Write();
        Plot_TotUnc_MCYield_WZ_Pt1[i]->Write();
        Plot_TotUnc_MCYield_WZ_Pt2[i]->Write();
        Plot_TotUnc_MCYield_WZ_Pt3[i]->Write();
        Plot_TotUnc_MCYield_WZ_Mll[i]->Write();
        Plot_TotUnc_MCYield_WZ_MT[i]->Write();
        Plot_TotUnc_MCYield_WZ_MET[i]->Write();
        Plot_TotUnc_MCYield_WZ_M3l[i]->Write();
        Plot_TotUnc_MCYield_WZ_SumQ[i]->Write();
    }
    outputRootFile->Close();
...
//Assign Uncertainty
void FinalYield::ShapeForLimitSetting_WZ(TH1F* Hist, int& nbin, const double& VarCoef){
    ...
    if (nbin==44) {
        ...
        for (int i=1; i<=nbin; i++) {
            ...
            Hist->SetBinContent(i,BinVal*(1+VarCoef*ShapeUnc[i-1]));
        }
    }
    //SR B-F: no shape uncertainty
